...
namespace Architect.API.Core.DataAccess.Security
{
    ...
    public sealed partial class RoleMemberNavigation
    {
        ...
        /// <summary>
        /// Último valor asignado a clave única de la tabla RoleMemberNavigation.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
        ...
        public static List<Architect.API.Core.Contracts.Security.RoleMemberNavigation> RetrieveByCode(int companyid, string code, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT RoleMemberNavigation.Id, RoleMemberNavigation.CompanyId, RoleMemberNavigation.RoleId, RoleMemberNavigation.Code, RoleMemberNavigation.Allow, RoleMemberNavigation.SecurityLevel, RoleMemberNavigation.CreateAction, RoleMemberNavigation.ReadAction, RoleMemberNavigation.UpdateAction, RoleMemberNavigation.DeleteAction, RoleMemberNavigation.ListAction, RoleMemberNavigation.PrintAction, RoleMemberNavigation.UpdateUserCode, RoleMemberNavigation.UpdateDate, rm.RoleName RoleDesc, NULL UpdateUserName FROM RoleMemberNavigation LEFT JOIN RoleMember rm ON rm.CompanyId=RoleMemberNavigation.CompanyId AND rm.RoleId=RoleMemberNavigation.RoleId  WHERE RoleMemberNavigation.CompanyId=:CompanyId AND RoleMemberNavigation.Code=:Code")
                .AddParameter("CompanyId", DbType.Decimal, 5, companyid)
