...
namespace Architect.API.Core.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecFlowRole
    {
        ...
        /// </summary>
        public static List<Architect.API.Core.Contracts.General.ProcessSpecFlowRole> RetrieveByStepId(int flowId, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT Id, ProcessSpecFlowRole.RoleId, rm.RoleName, ProcessSpecFlowRole.CompanyId, ProcessSpecFlowRole.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecFlowRole.UpdateDate " +
                        ...
                        {
                            result.Add(new Architect.API.Core.Contracts.General.ProcessSpecFlowRole()
                            {
