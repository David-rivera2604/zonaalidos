...
namespace Architect.API.Core.DataAccess.Traza
{
    /// <summary>
    ...
    public sealed partial class TrackRequest
    {
        ...
        public static int Create(Architect.API.Core.Contracts.Traza.TrackRequest trackrequestItem, IDbConnection connection = null)
        {
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de TrackRequest</returns>
        public static List<Architect.API.Core.Contracts.Traza.TrackRequest> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<Architect.DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Core.Contracts.Traza.TrackRequest> result = new List<Architect.API.Core.Contracts.Traza.TrackRequest>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Core.Contracts.Traza.TrackRequest trackrequestItem, IDbConnection connection = null)
        {
            if (trackrequestItem.UpdateDate.IsEmpty())
            {
                trackrequestItem.UpdateDate = DateTime.Now;
        ...
        public static List<int> Update(List<Architect.API.Core.Contracts.Traza.TrackRequest> trackrequestItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Core.Contracts.Traza.TrackRequest item in trackrequestItems)
            {
        ...
        public static Architect.API.Core.Contracts.Traza.TrackRequest DataReaderToTrackRequest(System.Data.IDataReader reader, Architect.API.Core.Contracts.Traza.TrackRequest item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Core.Contracts.Traza.TrackRequest();
            }
        ...
        /// </summary>
        /// <returns>Cantidad de registros actualizados.</returns>
        public static int Update2(Architect.API.Core.Contracts.Traza.TrackRequest trackrequestItem, IDbConnection connection = null)
        {
            if (trackrequestItem.UpdateDate.IsEmpty())
            {
                trackrequestItem.UpdateDate = DateTime.Now;
