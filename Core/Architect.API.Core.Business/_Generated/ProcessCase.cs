...
namespace Architect.API.Core.Business.General
{
    ...
    public static partial class ProcessCase
    {
        ...
        public static List<Architect.API.Core.Contracts.General.ProcessCase> Retrieve(int companyId, string filter, int beginIndex, int endIndex, int agentCodeActual = 0)
        {
        ...
        {
            Architect.API.Core.Contracts.General.ProcessCase result = Architect.API.Core.DataAccess.General.ProcessCase.Retrieve(id, companyId);
        ...
        public static Architect.API.Core.Contracts.General.ProcessCaseResult Update(int companyId, int userId, int id, Architect.API.Core.Contracts.General.ProcessCase item)
        {
            Architect.API.Core.Contracts.General.ProcessCase result = null;
            List<Contracts.General.Error> errors = Architect.API.Core.Business.General.ProcessCase.Validate(companyId, item, false, false);
            ...
            if (errors.Count == 0)
            {
                ...
                if (Architect.API.Core.DataAccess.General.ProcessCase.Update(result) > 0)
                {
                    MapLookups(companyId, result);
        ...
        public static Architect.API.Core.Contracts.General.ProcessCaseResult Delete(int companyId, int userId, int id)
        {
            Architect.API.Core.Contracts.General.ProcessCase result = null;
            ...
            if (errors.Count == 0)
            {
                ...
                if (result.IsNotEmpty() && Architect.API.Core.DataAccess.General.ProcessCase.Delete(id, companyId) > 0)
                {
        ...
        {
            return Architect.API.Core.DataAccess.General.ProcessCase.Count(Architect.API.Core.DataAccess.General.ProcessCase.FilterBuilder(filter));
        }
        ...
        public static List<Core.Contracts.General.Error> Validate(int companyId, Architect.API.Core.Contracts.General.ProcessCase source, bool isnew, bool isdelete)
        {
            ...
            if ((!isnew || isdelete) && source.Id.IsNotEmpty() && Architect.API.Core.DataAccess.General.ProcessCase.Count(source.Id, companyId) == 0)
            {
                result.Add(new Core.Contracts.General.Error() { Group = group, Key = "Id", Message = "La proceso no está registrada" });
            }
            if (isnew && source.Id.IsNotEmpty() && Architect.API.Core.DataAccess.General.ProcessCase.Count(source.Id, companyId) > 0)
            {
            ...
            if (isnew && source.InstanceId.IsNotEmpty() && Architect.API.Core.DataAccess.General.ProcessCase.Count(source.InstanceId, companyId) > 0)
            {
