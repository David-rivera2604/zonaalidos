...
namespace Architect.API.Core.Business.General
{
    ...
    public static partial class Navigation
    {
        ...
        {
            List<Architect.API.Core.Contracts.General.Navigation> result = Architect.API.Core.DataAccess.General.Navigation.RetrieveAll(companyId, Architect.API.Core.DataAccess.General.Navigation.FilterBuilder(filter), beginIndex, endIndex);
