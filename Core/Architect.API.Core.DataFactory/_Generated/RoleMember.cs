...
namespace Architect.API.Core.DataAccess.Security
{
    ...
    public static partial class RoleMember
    {
        ...
        public static int Create(Architect.API.Core.Contracts.Security.RoleMember rolememberItem, IDbConnection connection = null)
        {
            ...
            return Database.Insert("INSERT INTO RoleMember (RoleId, CompanyId, RoleName, Description, SecurityLevel, RecordStatus, UpdateUserCode, UpdateDate) " +
                                                 "VALUES(:RoleId, :CompanyId, :RoleName, :Description, :SecurityLevel, :RecordStatus, :UpdateUserCode, :UpdateDate)")
        ...
        public static Architect.API.Core.Contracts.Security.RoleMember Retrieve(int roleid, int companyId, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT RoleId, RoleMember.CompanyId, RoleName, Description, RoleMember.SecurityLevel, RoleMember.RecordStatus, RoleMember.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, RoleMember.UpdateDate " +
        ...
        public static List<Architect.API.Core.Contracts.Security.RoleMember> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                            "SELECT RoleId, RoleMember.CompanyId, RoleName, Description, RoleMember.SecurityLevel, RoleMember.RecordStatus, RoleMember.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, RoleMember.UpdateDate " +
        ...
        public static string FilterBuilder(string filter, bool includeWhere = true)
        {
            ...
            if (filter.IsNotEmpty())
            {
                ...
                result += "(";
                result += " UPPER(RoleMember.RecordStatus) LIKE '%" + filter.ToUpper() + "%' ";
        ...
        /// <summary>
        /// Último valor asignado a clave unica de la tabla RoleMember.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
