...
namespace Architect.API.Core.DataAccess.General
{
    ...
    public static partial class LookupMaster
    {
        ...
        public static Architect.API.Core.Contracts.General.LookupMaster Retrieve(int lookupid, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT LookupId, Type, Description, Key, Tenant, Statement, IsCached, ConnectionName, IncludeByRole, ExcludeByRole, LookupMaster.RecordStatus, LookupMaster.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, LookupMaster.UpdateDate " +
        ...
        public static List<Architect.API.Core.Contracts.General.LookupMaster> RetrieveAll(string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                            "SELECT LookupId, Type, Description, Key, Tenant, Statement, IsCached, ConnectionName, IncludeByRole, ExcludeByRole, LookupMaster.RecordStatus, LookupMaster.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, LookupMaster.UpdateDate " +
        ...
        /// <summary>
        /// Último valor asignado a clave unica de la tabla LookupMaster.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
