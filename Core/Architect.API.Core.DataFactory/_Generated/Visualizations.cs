...
namespace Architect.API.Core.DataAccess.General
{
    ...
    public static partial class Visualizations
    {
        ...
        public static int Create(Architect.API.Core.Contracts.General.Visualizations visualizationsItem, IDbConnection connection = null)
        {
            ...
            return Database.Insert("INSERT INTO Visualizations (Id, CompanyId, EntityType, Sequence, Type, Caption, Description, StatementType, Statement, Specification, Icon, IconClass, ValueFormat, ConnectionName, RecordStatus, UpdateUserCode, UpdateDate) " +
                                                 "VALUES(:Id, :CompanyId, :EntityType, :Sequence, :Type, :Caption, :Description, :StatementType, :Statement, :Specification, :Icon, :IconClass, :ValueFormat, :ConnectionName, :RecordStatus, :UpdateUserCode, :UpdateDate)")
                            ...
                            .AddParameter("Statement", DbType.AnsiString, 512, visualizationsItem.Statement)
                            .AddParameter("Specification", DbType.AnsiString, 2048, visualizationsItem.Specification)
        ...
        public static Architect.API.Core.Contracts.General.Visualizations Retrieve(int id, int companyId, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT Id, Visualizations.CompanyId, EntityType, Sequence, Type, Caption, Description, StatementType, Statement, Specification, Icon, IconClass, ValueFormat, ConnectionName, Visualizations.RecordStatus, Visualizations.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, Visualizations.UpdateDate " +
        ...
        public static List<Architect.API.Core.Contracts.General.Visualizations> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                            "SELECT Id, Visualizations.CompanyId, EntityType, Sequence, Type, Caption, Description, StatementType, Statement, Specification, Icon, IconClass, ValueFormat, ConnectionName, Visualizations.RecordStatus, Visualizations.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, Visualizations.UpdateDate " +
        ...
        /// <summary>
        /// Último valor asignado a clave unica de la tabla Visualizations.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
        ...
        public static int Update(Architect.API.Core.Contracts.General.Visualizations visualizationsItem, IDbConnection connection = null)
        {
            ...
            return Database.Update("UPDATE Visualizations " +
                                      "SET CompanyId=:CompanyId, EntityType=:EntityType, Sequence=:Sequence, Type=:Type, Caption=:Caption, Description=:Description, StatementType=:StatementType, Statement=:Statement, Specification=:Specification, Icon=:Icon, IconClass=:IconClass, ValueFormat=:ValueFormat, ConnectionName=:ConnectionName, RecordStatus=:RecordStatus, UpdateUserCode=:UpdateUserCode, UpdateDate=:UpdateDate " +
                                    "WHERE Id=:Id")
                                .AddParameter("CompanyId", DbType.Decimal, 5, visualizationsItem.CompanyId)
                                .AddParameter("EntityType", DbType.Decimal, 5, visualizationsItem.EntityType)
                                .AddParameter("Sequence", DbType.Decimal, 9, visualizationsItem.Sequence)
