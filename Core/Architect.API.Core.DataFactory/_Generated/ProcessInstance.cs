...
namespace Architect.API.Core.DataAccess.General
{
    ...
    public static partial class ProcessInstance
    {
        ...
        public static int Create(Architect.API.Core.Contracts.General.ProcessInstance processinstanceItem, IDbConnection connection = null)
        {
            ...
            return Database.Insert("INSERT INTO ProcessInstance (ActivityId, InstanceId, CompanyId, EntityType, EntityId, CaseId, FlowId, StepId, TaskId, Created, StartDate, DueDate, FinishDate, PreviousActivityId, UserId, Comments, UpdateUserCode, UpdateDate) " +
                                                 "VALUES(:ActivityId, :InstanceId, :CompanyId, :EntityType, :EntityId, :CaseId, :FlowId, :StepId, :TaskId, :Created, :StartDate, :DueDate, :FinishDate, :PreviousActivityId, :UserId, :Comments, :UpdateUserCode, :UpdateDate)")
        ...
        public static List<Architect.API.Core.Contracts.General.ProcessInstance> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                            "SELECT ActivityId, InstanceId, ProcessInstance.CompanyId, EntityType, EntityId, CaseId, FlowId, StepId, TaskId, Created, StartDate, DueDate, FinishDate, PreviousActivityId, ProcessInstance.UserId, Comments, ProcessInstance.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessInstance.UpdateDate " +
        ...
        /// <summary>
        /// Último valor asignado a clave unica de la tabla ProcessInstance.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
