...
namespace Architect.API.Core.Controllers
{
    ...
    public class ProcessSpecStepController : ApiController
    {
        ...
        [Route("")]
        [Authorize]
        public async Task<IHttpActionResult> Post([FromBody] Architect.API.Core.Contracts.General.ProcessSpecStep item)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecStepResult created = Architect.API.Core.Business.General.ProcessSpecStep.Create(tokenInfo.CompanyId, tokenInfo.UserId, item);
        ...
        public async Task<IHttpActionResult> Get([FromUri] string filter = "", int beginIndex = 1, int endIndex = int.MaxValue)
        {
            ...
            List<Architect.API.Core.Contracts.General.ProcessSpecStep> result = null;

            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecStep.RetrieveFull(tokenInfo.CompanyId, filter, beginIndex, endIndex);
            }).ConfigureAwait(false);
        ...
        public async Task<IHttpActionResult> Count([FromUri] string filter = "")
        {
            ...
            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecStep.Count(tokenInfo.CompanyId, filter);
            }).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        public async Task<IHttpActionResult> GetById([FromUri] int id)
        {
            ...
            Architect.API.Core.Contracts.General.ProcessSpecStep data = null;
            ...
            else
            {
                await Task.Run(() =>
                {
                    data = Architect.API.Core.Business.General.ProcessSpecStep.RetrieveById(tokenInfo.CompanyId, id);
                    if (data.IsEmpty())
                    {
                        result = NotFound();
                    }
        ...
        [Route("{id:int}")]
        [Authorize]
        public async Task<IHttpActionResult> Put([FromUri] int id, [FromBody] Architect.API.Core.Contracts.General.ProcessSpecStep item)
        {
            ...
            {
                item.Id = id;
                Architect.API.Core.Contracts.General.ProcessSpecStepResult updated = Architect.API.Core.Business.General.ProcessSpecStep.Update(tokenInfo.CompanyId, tokenInfo.UserId, id, item);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int id)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecStepResult deleted = Architect.API.Core.Business.General.ProcessSpecStep.Delete(tokenInfo.CompanyId, tokenInfo.UserId, id);
