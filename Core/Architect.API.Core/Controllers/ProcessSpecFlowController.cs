...
namespace Architect.API.Core.Controllers
{
    ...
    public class ProcessSpecFlowController : ApiController
    {
        ...
        [Route("")]
        [Authorize]
        public async Task<IHttpActionResult> Post([FromBody] Architect.API.Core.Contracts.General.ProcessSpecFlow item)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecFlowResult created = Architect.API.Core.Business.General.ProcessSpecFlow.Create(tokenInfo.CompanyId, tokenInfo.UserId, item);
        ...
        public async Task<IHttpActionResult> Get([FromUri] string filter = "", int beginIndex = 1, int endIndex = int.MaxValue)
        {
            ...
            List<Architect.API.Core.Contracts.General.ProcessSpecFlow> result = null;

            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecFlow.Retrieve(tokenInfo.CompanyId, filter, beginIndex, endIndex);
            }).ConfigureAwait(false);
        ...
        public async Task<IHttpActionResult> Count([FromUri] string filter = "")
        {
            ...
            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecFlow.Count(tokenInfo.CompanyId, filter);
            }).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        public async Task<IHttpActionResult> GetById([FromUri] int id)
        {
            ...
            else
            {
                await Task.Run(() =>
                {
                    data = Architect.API.Core.Business.General.ProcessSpecFlow.RetrieveById(tokenInfo.CompanyId, id);
                    if (data.IsEmpty())
                    {
                        result = NotFound();
                    }
        ...
        [Route("{id:int}")]
        [Authorize]
        public async Task<IHttpActionResult> Put([FromUri] int id, [FromBody] Architect.API.Core.Contracts.General.ProcessSpecFlow item)
        {
            ...
            {
                item.Id = id;
                Architect.API.Core.Contracts.General.ProcessSpecFlowResult updated = Architect.API.Core.Business.General.ProcessSpecFlow.Update(tokenInfo.CompanyId, tokenInfo.UserId, id, item);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int id)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecFlowResult deleted = Architect.API.Core.Business.General.ProcessSpecFlow.Delete(tokenInfo.CompanyId, tokenInfo.UserId, id);
