...
namespace Architect.API.Core.Controllers
{
    ...
    public class ProcessSpecLinkController : ApiController
    {
        ...
        [Route("")]
        [Authorize]
        public async Task<IHttpActionResult> Post([FromBody] Architect.API.Core.Contracts.General.ProcessSpecLink item)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecLinkResult created = Architect.API.Core.Business.General.ProcessSpecLink.Create(tokenInfo.CompanyId, tokenInfo.UserId, item);
        ...
        public async Task<IHttpActionResult> Get([FromUri] string filter = "", int beginIndex = 1, int endIndex = int.MaxValue)
        {
            ...
            List<Architect.API.Core.Contracts.General.ProcessSpecLink> result = null;

            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecLink.Retrieve(tokenInfo.CompanyId, filter, beginIndex, endIndex);
            }).ConfigureAwait(false);
        ...
        public async Task<IHttpActionResult> Count([FromUri] string filter = "")
        {
            ...
            await Task.Run(() =>
            {
                result = Architect.API.Core.Business.General.ProcessSpecLink.Count(tokenInfo.CompanyId, filter);
            }).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        public async Task<IHttpActionResult> GetById([FromUri] int id)
        {
            ...
            Architect.API.Core.Contracts.General.ProcessSpecLink data = null;
            ...
            else
            {
                await Task.Run(() =>
                {
                    data = Architect.API.Core.Business.General.ProcessSpecLink.RetrieveById(tokenInfo.CompanyId, id);
                    if (data.IsEmpty())
                    {
                        result = NotFound();
                    }
        ...
        [Route("{id:int}")]
        [Authorize]
        public async Task<IHttpActionResult> Put([FromUri] int id, [FromBody] Architect.API.Core.Contracts.General.ProcessSpecLink item)
        {
            ...
            {
                item.Id = id;
                Architect.API.Core.Contracts.General.ProcessSpecLinkResult updated = Architect.API.Core.Business.General.ProcessSpecLink.Update(tokenInfo.CompanyId, tokenInfo.UserId, id, item);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int id)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Core.Contracts.General.ProcessSpecLinkResult deleted = Architect.API.Core.Business.General.ProcessSpecLink.Delete(tokenInfo.CompanyId, tokenInfo.UserId, id);
