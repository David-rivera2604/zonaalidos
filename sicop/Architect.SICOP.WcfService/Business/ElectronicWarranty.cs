    ...
    public sealed class ElectronicWarranty
    {
        public static Contracts.ExecGurtReponse Ejecutar_O_Liberar(Contracts.ExecGurtRequest value)
        {
            ...
            try
            {
                ...
                {
                    Utilities.Log.TraceLog("Ejecutar_O_Liberar request", JsonConvert.SerializeObject(value), "ElectronicWarranty");
                    ...
                    /// Si no se ha cambiado el codigo de confirmación por default, quiere decir que no hay error
            ...
            catch (Exception ex)
            {
                ...
                result.Msg_err = "Error interno";
            }
            Utilities.Log.TraceLog("Ejecutar_O_Liberar response", JsonConvert.SerializeObject(result), "ElectronicWarranty");
            return result;
        }
