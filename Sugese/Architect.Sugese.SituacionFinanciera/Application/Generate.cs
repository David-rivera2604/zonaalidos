    ...
    public class Generate : Architect.Sugese.Domain.GenerateBase
    {
        ...
        private static Domain.ModeloSituacionFinanciera ModelInit(DateTime period)
        {
            Domain.ModeloSituacionFinanciera model = new Domain.ModeloSituacionFinanciera()
            {
                ...
                {
                    NombreArchivo = String.Format("{0}-ModeloSituacionFinanciera", "sugese.entidadaseguradora".StringValue(0, "Mapfre Seguros Costa Rica S.A.")),
        ...
        {
            Utilities.SerializeHandler.SerializeToFile<Domain.ModeloSituacionFinanciera>(model, xmlFileName, false);
