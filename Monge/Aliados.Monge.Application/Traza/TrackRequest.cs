...
namespace Aliados.Monge.Application.Traza
{
    /// <summary>
    ...
    public static partial class TrackRequest
    {
        ...
        public static Domain.Traza.TrackRequest Add(int companyId, int userId, Domain.Traza.TrackRequest item)
        {
            item.Id = Infrastructure.Data.Traza.TrackRequest.RetrieveLastKey() + 1;

            item.CompanyId = companyId;
            item.UpdateUserCode = userId;
            item.UpdateDate = DateTime.Now;

            Infrastructure.Data.Traza.TrackRequest.Create(item);
            return item;
        }
        ...
        public static void Update(int companyId, int userId, int id, Domain.Traza.TrackRequest item)
        {
            ...
            item.UpdateUserCode = userId;
            item.UpdateDate = DateTime.Now;
            Infrastructure.Data.Traza.TrackRequest.Update2(item);
        }
        ...
        //public static Aliados.Monge.Domain.Traza.TrackRequestResult CreateOrUpdate(int companyId, int userId, Architect.API.Insurance.Contracts.Policy.TrackRequest item)
        //{
