...
namespace Aliados.Monge.Application.Seguridad
{
    public sealed class SeguridadHandler
    {
        ...
        public static async Task<Domain.Seguridad.Respuesta> Autorizacion(string clienteID, string secretID)
        {
            if (string.IsNullOrEmpty(clienteID) || string.IsNullOrEmpty(secretID))
            {
                return null;
            }
            Domain.Seguridad.Respuesta result = new Domain.Seguridad.Respuesta()
            {
