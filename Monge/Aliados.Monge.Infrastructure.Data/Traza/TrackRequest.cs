...
namespace Aliados.Monge.Infrastructure.Data.Traza
{
    /// <summary>
    ...
    public sealed partial class TrackRequest
    {
        ...
        public static int Create(Aliados.Monge.Domain.Traza.TrackRequest trackrequestItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Aliados.Monge.Domain.Traza.TrackRequest> trackrequestItems, IDbConnection connection = null)
        {
            ...
            foreach (Aliados.Monge.Domain.Traza.TrackRequest item in trackrequestItems)
            {
        ...
        public static Aliados.Monge.Domain.Traza.TrackRequest Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Aliados.Monge.Domain.Traza.TrackRequest> RetrieveAll(int companyId, string filter, List<Architect.DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Aliados.Monge.Domain.Traza.TrackRequest> result = new List<Aliados.Monge.Domain.Traza.TrackRequest>();
            Database.Select("SELECT Id, TrackRequest.CompanyId, DocumentId, RequestType, RequestBody, RequestTimeStamp, MessageId, ResponseStatus, ResponseText, ResponseBody, ResponseTimeStamp, TrackRequest.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, TrackRequest.UpdateDate " +
                              "FROM TrackRequest LEFT JOIN UserMember um ON um.UserId = TrackRequest.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de TrackRequest</returns>
        public static List<Aliados.Monge.Domain.Traza.TrackRequest> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<Architect.DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Aliados.Monge.Domain.Traza.TrackRequest> result = new List<Aliados.Monge.Domain.Traza.TrackRequest>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Aliados.Monge.Domain.Traza.TrackRequest trackrequestItem, IDbConnection connection = null)
        {
            if (trackrequestItem.UpdateDate.IsEmpty())
            {
                trackrequestItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Aliados.Monge.Domain.Traza.TrackRequest> trackrequestItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Aliados.Monge.Domain.Traza.TrackRequest DataReaderToTrackRequest(System.Data.IDataReader reader, Aliados.Monge.Domain.Traza.TrackRequest item = null)
        {
            if (item == null)
            {
                item = new Aliados.Monge.Domain.Traza.TrackRequest();
            }
