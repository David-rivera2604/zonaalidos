...
app.VariacionHogarTotal = (function () {
    ...
    function existeCambios() {
        let result = true;
        const camposAComparar = ["sAEdificio", "sAObjetosvaliosos", "sADomocristalmarmolgranito", "sAGastosalquiler", "sAPerdidaderentas",
            "sARespcivil", "sAMobiliario", "mesesaampararporperdrentas"];
    ...
    function MapObjectToInput_First(data) {
        ...
        console.log("data.fec_vcto_poliza", data.fec_vcto_poliza);
        ...
        console.log("data.sAEdificio", data.sAEdificio);
