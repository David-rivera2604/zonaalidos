...
app.SecurityRoleMember = (function () {
    ...
    function Refresh() {
        ...
        app.core.Get(app.setting.apipath + 'v1/RoleMember/Get?filter=' + filter + recordStatusFltVal)
            ...
            columns: [
                {
                    ...
                    formatter: 'app.ui.EditLinkFormatter'
                }, {
                    field: 'Description',
                    title: 'Descripción',
                    sortable: true,
        ...
        toastr.warning("Si está seguro de querer eliminar el rol '" + uidata.RoleName + "' haga clic aquí", null,
            {
                ...
                onclick: function () {
                    ...
                    app.core.Delete(app.setting.apipath + 'v1/RoleMember/Delete?id=' + uidata.RoleId)
                        .done(function (data, textStatus, jqXHR) {
