...
app.CotizacionEstudiantil = (function () {
    ...
    function Controls_Events() {
        ...
        $('#print').click(function () {
            event.preventDefault();
            app.Cotizacion.Imprimir('Estudiantil', app.CotizacionEstudiantil.Data());
        });

        $('#emitir').click(function () {
            event.preventDefault();
            window.location.replace(app.setting.basepath + 'emision/Estudiantil?presupuesto=' + quoteData.presupuesto + workMode);
        });
    };
    ...
    function Quote() {
        ...
        app.core.Post(app.setting.apipath + 'v1/Quote/EstudiantilQuote',
