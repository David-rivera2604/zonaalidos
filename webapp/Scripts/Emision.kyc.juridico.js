...
app.kycjuridico = (function () {
    ...
    function MapInputToObject() {
        var data = {
            ...
            fondospormivilizarJurDesc: app.ui.GetRadioSelectedText('fondospormivilizarJur'),
            actividadesart15Jur: app.ui.GetRadioNumericValue('actividadesart15Jur'),
            actividadesart15JurDesc: app.ui.GetRadioSelectedText('actividadesart15Jur'),
            activoscorrespondenJur: app.ui.GetRadioNumericValue('activoscorrespondenJur'),
            activoscorrespondenJurDesc: app.ui.GetRadioSelectedText('activoscorrespondenJur'),
            pepcargoJur: app.ui.GetRadioNumericValue('pepcargoJur'),
            pepcargoJurDesc: app.ui.GetRadioSelectedText('pepcargoJur'),
            pepduracionJur: $('#pepduracionJur').val(),
            peprelacionJur: app.ui.GetRadioNumericValue('peprelacionJur'),
            peprelacionJurDesc: app.ui.GetRadioSelectedText('peprelacionJur'),
            ...
            periodicidadJurDesc: app.ui.GetRadioSelectedText('periodicidadJur'),
            ...
            formadepagodelapolizaJurDesc: app.ui.GetRadioSelectedText('formadepagodelapolizaJur'),
            mediodeenvioJur: app.ui.GetRadioNumericValue('mediodeenvioJur'),
            mediodeenvioJurDesc: app.ui.GetRadioSelectedText('mediodeenvioJur'),
