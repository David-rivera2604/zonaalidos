...
|zona|4
 ...
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 350, @_@_)', STATEMENTEXTEND=NULL, "KEY"=NULL, JAVASCRIPTTOINCLUDE='Extend.Claims.js' WHERE ID=350 AND "SEQUENCE"=1;