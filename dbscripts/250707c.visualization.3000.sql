...
ORDER BY fec_efec_spto desc',NULL,NULL,NULL,NULL,1,1,10509,TIMESTAMP'2022-05-31 00:00:00',TO_CLOB('{
"title": "Mis pólizas",
"table": {
    "pagination": true,
    "search": true,
...
}'),'Tron',1,NULL,NULL,NULL,'Extend.js');
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,"STATEMENT",ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,STATEMENTEXTEND,"KEY",JAVASCRIPTTOINCLUDE) VALUES (3000,2,1,'Mis siniestros','Cliente conectado','SELECT s.num_sini, s.num_poliza, s.num_riesgo, s.fec_denu_sini, a.nom_ramo, em_f_nom_riesgo_web (s.cod_cia, s.num_poliza, s.num_spto, s.num_riesgo) nom_riesgo, c.nom_valor
 ...
 ORDER BY s.fec_denu_sini',NULL,NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-11-24 16:36:23',TO_CLOB('{
    "title": "Siniestros",
    "table": {
        "pagination": true,
        "search": true,
