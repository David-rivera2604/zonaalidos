...
Datos generales|zona|3
 ...
 INSERT INTO NAVIGATION (NAVIGATIONID,COMPANYID,CODE,PARENTCODE,"TYPE",TITLE,MENUTITLE,DESCRIPTION,URLPATH,URLHELP,SMALLIMAGE,BIGIMAGE,"SEQUENCE",RECORDSTATUS,UPDATEUSERCODE,UPDATEDATE) VALUES ((SELECT NVL(MAX(navigationid),0)+1 FROM NAVIGATION),100,'GARELEMN',NULL,1,'Garantías electrónicas',NULL,NULL,'Cases',NULL,'fa fa-ticket',NULL,970,1,999999006,TIMESTAMP'2024-05-13 15:33:24');
INSERT INTO NAVIGATION (NAVIGATIONID,COMPANYID,CODE,PARENTCODE,"TYPE",TITLE,MENUTITLE,DESCRIPTION,URLPATH,URLHELP,SMALLIMAGE,BIGIMAGE,"SEQUENCE",RECORDSTATUS,UPDATEUSERCODE,UPDATEDATE) VALUES ((SELECT NVL(MAX(navigationid),0)+1 FROM NAVIGATION),100,'GAREL000','GARELEMN',2,'Consulta General',NULL,NULL,'viewer/viewer?id=9103',NULL,NULL,NULL,904,1,999999006,TIMESTAMP'2024-05-13 15:32:06');
