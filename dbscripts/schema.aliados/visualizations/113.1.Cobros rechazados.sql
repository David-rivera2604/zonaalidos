...
|zona|4
 ...
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 113, @_@_)', NULL, 'CobrosRechazados', 'Extend.CobrosRechazados.js', 'WITH NOTAPPROVED AS (
