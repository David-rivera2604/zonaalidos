DELETE FROM ALIADOS.RESTENDPOINTS WHERE id IN (100, 109);
...
INSERT INTO ALIADOS.RESTENDPOINTS (ID,"PATH","SEQUENCE",VERB,SUMMARY,DESCRIPTION,STATEMENTTYPE,DATASOURCE,"STATEMENT",ONERECORD,"SOURCE",ALIAS,AUTHORIZATIONREQUIRED,ROLES,CONTROLLERNAME,APPNAME,TRACED,PRECONDITION,VALIDATIONS,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,PRECALL,POSTCALL) VALUES (100,'Claim/ASIGES',1,'GET','Siniestro por ASIGES',NULL,'SELECT',2,'select a80.NUM_SINI, a80.NUM_EXP, a80.TXT_DANO_VEHI,
 ...
 where a80.COD_CIA= 1 AND a80.NUM_SINI={claim:NUMBER.15:Required} AND a80.OBS = {code:varchar2.40:Required}',1,'Custom','General',1,NULL,'Siniestros','TRON',0,NULL,NULL,1,0,6329,TIMESTAMP'2023-06-13 00:00:00',NULL,NULL);
