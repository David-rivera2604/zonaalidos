...
SELECT PI.INSTANCEID, PF.NAME, PI.STARTDATE
...
SELECT PC.ID "Caso #", PINIT.STARTDATE "Inicio", F.STARTDATE "Inicio de etapa de devolución", PINIT.FINISHDATE "Completado",
