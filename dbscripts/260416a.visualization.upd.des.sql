...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (11,1,1,'Auditoria de acceso','Listado con la información de acceso de los usuarios del sistema','UserSystemAccessInformationList',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-04-08 19:56:10',TO_CLOB('{
    "title": "@Title@",
    "table": {
        "entity": "UserSystemAccessInformationList",
        "pagination": true,
        "search": true,
        "showToggle": true,
        "showRefresh": true,
        ...
        "columns": [
            ...
            },
            {
                ...
                "halign": "center",
                "align": "left",
                "formatter": "app.u')||TO_CLOB('i.StringFormatter"
            },
            {
                "field": "Sucursal",
                "title": "Sucursal",
...
|zona|4
 ...
 WHERE A.COMPANYID={app.companyid} AND TRUNC(EFFECTDATE)>={desde:date} AND TRUNC(EFFECTDATE)<={hasta:date}  
  ORDER BY A.ID DESC'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (17,1,1,'Detalle de actividades por usuario','Listado con las actividades realizadas por un usuario','DetailActivities',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-08 19:09:32',TO_CLOB('{
    "title": "Listado con las actividades realizadas por un usuario",
    "table": {
        "entity": "DetailActivities",
        "pagination": true,
        "search": true,
        "showToggle": true,
        "showRefresh": true,
...
}'),'Research',1,NULL,NULL,NULL,TO_CLOB('SELECT C.UPDATEUSERCODE "Id", U.USERNAME "Usuario", C.UPDATEDATE "Fecha", L.DESCRIPTION "Entidad", C.ENTITYID "Referencia", C.ACTION "Acción", C.SUMMARY "Descripción" FROM CHANGESET C
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (18,1,1,'Usuarios por rol','Listado de usuarios agrupado por rol','UserListGroupedByRole',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-09 14:03:25',TO_CLOB('{
    "title": "Listado de usuarios agrupado por rol",
    "table": {
        "entity": "UserListGroupedByRole",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (111,1,1,'Resultado Cobros Sinpe Móvil','Resultado Cobros Sinpe Móvil',NULL,NULL,NULL,NULL,1,1,111,TIMESTAMP'2025-08-27 00:00:00',NULL,'Research',1,'|título
|zona|4
 Desde+|fechainicio|default=today
 Hasta+|fechafin|default=today
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 11, @_@_)','ReporteCobroSinpe',NULL,TO_CLOB('SELECT CASE WHEN MONEDA = 1 THEN ''HSBC1'' ELSE ''HSBC2'' END ENTIDAD_BANCARIA,
	   IDENTIFICACIONCLIENTE IDENTIFICACION_CLIENTE,
	   NOMBRECLIENTE  NOMBRE_CLIENTE,
	   FECHA ,
	   CODREFERENCIABANCO  NUMERO_COMPROBANTE,
	   MONTO,
	   DESCRIPCION  APLICADO_A_LA_POLIZA,
	   CASE WHEN RAZON like ''%Pago realizado exitosamente%'' THEN ''APROBADO'' ELSE ''RECHAZADO'' END ESTADO,
	   RAZON  RESULTADO
FROM SINPEMOVIL
WHERE FECHA BETWEEN {desde:date} AND {hasta:date}

'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (113,1,1,'Cobros rechazados','Cobros rechazados','RejectedCharges',NULL,NULL,NULL,1,1,111,TIMESTAMP'2025-08-31 00:00:00',TO_CLOB('{
  "title": "Cobros rechazados",
  "table": {
    "entity": "RejectedCharges",  
    "skipload": false,
    "pagination": true,
    "search": true,
    "showToggle": false,
...
|zona|4
 ...
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 113, @_@_)','CobrosRechazados','Extend.CobrosRechazados.js',TO_CLOB('SELECT DISTINCT null Sel, OP.POLICYID, OP.BILLNUMBER, OP.AMOUNT, OP.CURRENCY Cod_Mon, OP.STATUSDATE, OP.REASON
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (121,1,1,'Ejecuciones de cobros recurrentes','Ejecuciones de cobros recurrentes','RecurringChargeExecutions',NULL,NULL,NULL,1,1,1,TIMESTAMP'2025-05-28 19:56:10',TO_CLOB('{
  "title": "Ejecuciones de cobros recurrentes",
  "table": {
    "entity": "RecurringChargeExecutions",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": false,
...
}'),'Research',1,NULL,NULL,NULL,TO_CLOB('SELECT MIN(ISSUEDATE) STARTDATE, MAX(STATUSDATE) FINISHDATE, PROCESSID, COUNT(POLICYID) POLICYCOUNT, COUNT(BILLNUMBER) BILLCOUNT, MIN(POLICYID) FIRSTPOLICY, MIN(BILLNUMBER) FIRSTBILL
FROM ONLINEPAYMENT
WHERE "SOURCE" = ''Recurring''
GROUP BY PROCESSID ORDER BY STARTDATE DESC
FETCH FIRST 1000 ROWS ONLY'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (300,1,1,'Polizas activas','Mis clientes - Agente conectado','ActivePolicies',NULL,NULL,NULL,1,1,777,TIMESTAMP'2023-02-27 21:49:26',TO_CLOB('{
...
}'),'Tron',2,NULL,NULL,'Extend.Policy.js',TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_policy_by_agent_tomador {app.P_COD_CIA} {app.P_COD_AGT}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (300,2,1,'Pólizas canceladas','Mis clientes - Agente conectado','CancelledPolicies',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Pólizas canceladas",
    "table": {
        "entity": "CancelledPolicies",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_policies_cancelled {app.P_COD_CIA} {app.P_COD_AGT}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (300,3,1,'Siniestros activos','Mis clientes - Agente conectado','ActiveClaims',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
...
'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_claims {app.P_COD_CIA} {app.P_COD_AGT} {const.P}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (300,4,1,'Siniestros pagados','Mis clientes - Agente conectado','PaidClaims',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
...
'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_claims {app.P_COD_CIA} {app.P_COD_AGT} {const.T}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (301,1,1,'Pólizas activas por agente','Filtro','ActivePoliciesByAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2021-03-18 10:55:28',TO_CLOB('{
    "title": "Pólizas activas",
    "table": {
        "entity": "ActivePoliciesByAgent",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 Agente+|lista|name=cod_agt;lookup=Agents
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 301, @_@_)',NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_policy_by_agent_tomador {app.P_COD_CIA} {cod_agt}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,1,1,'Detalle de la póliza - Datos generales','Detalle...','PolicyDetailGeneral',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Datos generales",
    "table": {
        "entity": "PolicyDetailGeneral",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',1,NULL,NULL,'Extend.Policy.js',TO_CLOB('SELECT A30.COD_CIA,
       A30.COD_SECTOR,
       A30.COD_RAMO,
       A30.NUM_POLIZA,
       A30.NUM_SPTO,
 ...
 WHERE A30.COD_CIA = {app.p_cod_cia}
   ...
   AND ROWNUM =1'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,2,1,'Detalle de la póliza - Terceros','Detalle...','PolicyDetailThrid',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Terceros",
    "table": {
        "entity": "PolicyDetailThrid",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Batch_Contract_mcr.pp_lee_a2000060 {app.p_cod_cia} {P_NUM_POLIZA:varchar} {P_NUM_SPTO} {P_NUM_APLI} {P_NUM_SPTO_APLI}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,3,1,'Detalle de la póliza - Información del riesgo','Detalle...','PolicyDetailRisk',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Información del riesgo",
    "table": {
        "entity": "PolicyDetailRisk",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Batch_Contract_mcr.pp_lee_a2000020 {app.p_cod_cia} {P_NUM_POLIZA:varchar} {P_NUM_SPTO} {P_NUM_APLI} {P_NUM_SPTO_APLI}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,4,1,'Detalle de la póliza - Coberturas','Detalle...','PolicyDetailCoverage',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Coberturas",
    "table": {
        "entity": "PolicyDetailCoverage",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
        ...
        "columns": [
            ...
            },
            {
                ...
                "halign": "center",
                "align": "right",
                "formatter": "app.ui.')||TO_CLOB('DecimalFormatter",
                "visible": false
            },
            {
                "field": "IMP_FRACC",
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Batch_Contract_mcr.pp_lee_a2000040_result {app.p_cod_cia} {P_NUM_POLIZA:varchar} {P_NUM_SPTO} {P_NUM_APLI} {P_NUM_SPTO_APLI}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,5,1,'Detalle de la póliza - Plan de pagos','Detalle...','PolicyDetailPaymentPlan',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
  "title": "Plan de pagos",
  "table": {
    "entity": "PolicyDetailPaymentPlan",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Batch_Contract_mcr.pp_lee_a2990700_result {app.p_cod_cia} {P_NUM_POLIZA:varchar} {P_NUM_SPTO} {P_NUM_APLI} {P_NUM_SPTO_APLI}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,6,1,'Detalle de la póliza - Documentos requeridos','Detalle...','PolicyDetailDocuments',NULL,NULL,NULL,1,1,77,TIMESTAMP'2021-12-21 10:19:24',TO_CLOB('{
  "title": "Documentos cargados",
  "class": "role-Callcenter-notvisible",
  "table": {
    "entity": "PolicyDetailDocuments",  
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_jrp_cuadro_poliza_302_mcr.p_lista_certificado_historico {app.p_cod_cia} {P_NUM_POLIZA:varchar}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (302,8,1,'Detalle de la poliza - Certificado Actual','Detalle...','PolicyDetailCertif',NULL,NULL,NULL,1,1,888,TIMESTAMP'2023-03-31 00:00:00',TO_CLOB('{
  "title": "Certificado",
  "table": {
    "entity": "PolicyDetailCertif",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Tron',1,NULL,NULL,NULL,TO_CLOB('SELECT A30.COD_CIA,
       A30.COD_SECTOR,
       A30.COD_RAMO,
       A30.NUM_POLIZA,
       A30.NUM_SPTO,
 ...
 WHERE A30.COD_CIA = {app.p_cod_cia}
   ...
   AND A30.NUM_SPTO_APLI = 0
   AND ROWNUM =1'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (303,1,1,'Asignaciones','Detalle...','CommissionAssignmentsPaid',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
"title": "Asignaciones",
"table": {
    "entity": "CommissionAssignmentsPaid",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_paid_commissionDet {app.P_COD_CIA} {app.P_COD_AGT} {p_cod_mon} {p_fec_proceso:date}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (303,2,1,'Deducciones','Detalle...','CommissionDeductions',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Deducciones",
    "table": {
        "entity": "CommissionDeductions",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_paid_commissionDetDeduc {app.P_COD_CIA} {app.P_COD_AGT} {p_cod_mon} {p_fec_proceso:date}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (304,1,1,'Polizas Canceladas por agente','Filtro','PoliciesCancelledByAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2024-02-23 00:00:00',TO_CLOB('{
    "title": "Polizas canceladas",
    "table": {
        "entity": "PoliciesCancelledByAgent",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 Agente+|lista|name=cod_agt;lookup=Agents
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 301, @_@_)',NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_policies_cancelled {app.P_COD_CIA} {cod_agt}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (305,1,1,'Polizas de Caución','Consultas MAPFRE - Caución','SuretyPolicies',NULL,NULL,NULL,1,1,777,TIMESTAMP'2023-02-27 21:49:26',TO_CLOB('{
"title": "Pólizas de Caución",
"table": {
"entity": "SuretyPolicies",
"pagination": true,
"search": true,
"showToggle": false,
"showRefresh": true,
...
"halign": "center",
"align": "left",
"formatter": "function (value, ')||TO_CLOB('row, index, field) { return ''<a href=tabrender?id=302&P_NUM_POLIZA='' + row.NUM_POLIZA + ''&P_NUM_SPTO='' + row.NUM_SPTO +'' onclick=app.ViewerQuery.TabRender(this); return false;>'' + value + ''</a>''; }"
},
{
"field": "ABR_RAMO",
"title": "Ramo",
...
{
"fi')||TO_CLOB('eld": "FEC_VCTO_POLIZA",
"title": "Fin de vigencia",
"sortable": true,
"halign": "center",
"align": "center",
...
}'),'Tron',1,NULL,NULL,'Extend.Policy.js',TO_CLOB('SELECT DISTINCT 
    a.cod_cia,
    a.num_poliza,
...
ORDER BY 
    a.num_poliza'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (309,1,1,'Detalle del siniestro (Expedientes)','Detalle...','ClaimDetailFiles',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
"title": "Detalle del siniestro (Expedientes)",
"table": {
  "entity": "ClaimDetailFiles",
"pagination": true,
"search": true,
"showToggle": true,
"showRefresh": true,
...
}'),'Tron',1,NULL,NULL,NULL,TO_CLOB('SELECT a90.num_poliza, a31.num_riesgo, a31.nom_riesgo nom_riesgo, a90.tip_docum_tomador,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (310,1,1,'Pólizas emitidas','Mi cuenta - Agente conectado','MyAccountIssuedPolicies',NULL,NULL,NULL,1,1,1,TIMESTAMP'2021-01-04 21:35:45',TO_CLOB('{
    "Ondemand" : true,
    "title": "@Title@",
    "entity": "MyAccountIssuedPolicies",
    "table": null,
    "chart": {
        "type": "area",
        "series": "YEAR",
...
}'),'Tron',1,NULL,NULL,NULL,TO_CLOB('SELECT EXTRACT (MONTH FROM FEC_EMISION_SPTO) Month,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (310,2,1,'Recibos pendientes','Mi cuenta - Agente conectado','MyAccountOutstandingBills',NULL,NULL,NULL,1,1,2025,TIMESTAMP'2025-01-15 00:00:00',TO_CLOB('{
"title": "Recibos pendientes",
"maintitle": "Mi cuenta",
"table": {
  "entity": "MyAccountOutstandingBills",
	"pagination": true,
	"search": true,
	"showToggle": false,
	"showRefresh": true,
	...
	"columns": [
		...
		},
		{
			...
			"halign": "center",
			"align": "center",
			"formatter": "app.ui.DateFormatter"')||TO_CLOB('
		},
		{
			"field": "TIP_DOCUM",
...
}'),'Tron',1,NULL,NULL,'Extend.js',TO_CLOB('SELECT   a.num_poliza, a.fec_efec_poliza, a.fec_vcto_poliza, a.tip_docum, a.cod_docum, 1 num_spto,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (310,3,1,'Comisiones pagadas','Mi cuenta - Agente conectado','MyAccountCommiPaid',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Comisiones pagadas",
    "class": "d-none role-Intermediario_admi-visible",
    "table": {
      "entity": "MyAccountCommiPaid",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_paid_commission {app.P_COD_CIA} {app.P_COD_AGT}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (310,4,1,'Comisiones estimadas por pagar','Mi cuenta - Agente conectado','MyAccountCommiPayable',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
    "title": "Comisiones estimadas por pagar",
    "class": "d-none role-Intermediario_admi-visible",
    "table": {
      "entity": "MyAccountCommiPayable",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_pending_commission {app.P_COD_CIA} {app.P_COD_AGT}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (311,1,1,'Información del cliente','Detalle...','ClientInfo',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
...
}'),'Tron',1,NULL,NULL,NULL,TO_CLOB('SELECT a1331.cod_docum, a1331.tip_docum, v1390.nom_completo, a1331.tlf_numero, a1331.tlf_numero_com, a1331.fax_numero, a1331.fax_numero_com, NVL (a1331.email, ''***'') email, NOM_DOMICILIO1, noM_DOMICILIO2, noM_DOMICILIO3, a1331.cod_docum || ''-'' || a1331.tip_docum key
  FROM a1001331 a1331
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (316,1,1,'Asignaciones','Detalle...','CommissionAssignmentsPend',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-07-24 14:38:50',TO_CLOB('{
"title": "Asignaciones",
"table": {
    "entity": "CommissionAssignmentsPend",
"pagination": true,
"search": true,
"showToggle": true,
"showRefresh": true,
...
"columns": [
    ...
    },
    {
        ...
        "halign": "center",
        "align": "center",
  ')||TO_CLOB('      "formatter": "app.ui.DateFormatter",
        "visible": true
    },
    {
        "field": "NOM_COMPLETO",
...
}'),'Tron',2,NULL,NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_pending_commissionDet {app.P_COD_CIA} {app.P_COD_AGT} {p_cod_mon}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (317,1,1,'Recibos pendientes de cobro','Para el agente conectado','OutstandingBills',NULL,NULL,NULL,1,1,6329,TIMESTAMP'2021-06-15 14:14:20',TO_CLOB('{
"title": "Recibos pendientes de cobro",
"table": {
  "entity": "OutstandingBills",
   "pagination": true,
   "search": true,
   "showToggle": false,
   "showRefresh": true,
...
|zona|4
 Desde+|fechainicio|default=today
 Hasta+|fechafin|default=today
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 11, @_@_)',NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_pending_receipts {app.P_COD_CIA} {app.P_COD_AGT} {desde:date} {hasta:date}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (318,1,1,'Recibos cobrados','Para el agente conectado','CollectedBills',NULL,NULL,NULL,1,1,6329,TIMESTAMP'2021-06-15 14:14:20',TO_CLOB('{
  "title": "Recibos cobrados",
  "table": {
        "entity": "CollectedBills",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 ...
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 318, @_@_)',NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_premium_collection {app.P_COD_CIA} {app.P_COD_AGT} {mes} {anio}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (320,1,1,'Cotizaciones','Para el agente conectado','Quotations',NULL,NULL,NULL,1,1,10509,TIMESTAMP'2022-05-31 00:00:00',TO_CLOB('{
    "title": "Cotizaciones",
    "table": {
        "entity": "Quotations",
        "pagination": true,
 ...
 }'),'Tron',1,NULL,NULL,'Extend.js',TO_CLOB('SELECT p30.cod_ramo, a1800.NOM_RAMO, p30.num_poliza "NUM_PRESUPUESTO", p30.fec_actu,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (321,1,1,'Detalle de la póliza - Documentos requeridos','Detalle...','PolicyDetailDocumentsByQuote',NULL,NULL,NULL,1,1,77,TIMESTAMP'2021-12-21 10:19:24',TO_CLOB('{
  "title": "Documentos asociados al presupuesto",
  "table": {
    "entity": "PolicyDetailDocumentsByQuote",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Research',1,NULL,NULL,NULL,TO_CLOB('SELECT ID, DOCUMENTTYPE, DESCRIPTION, FILENAME, FILESIZE
 FROM ATTACHMENTS
WHERE COMPANYID={app.companyid} AND ENTITYTYPE=3000 AND ENTITYID={P_NUM_POLIZA}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (322,1,1,'Cotizaciones por agente','Cotizaciones por agente','QuotationsByAgent',NULL,NULL,NULL,1,1,10509,TIMESTAMP'2022-05-31 00:00:00',TO_CLOB('{
    "title": "Cotizaciones por agente",
    "table": {
        "entity": "QuotationsByAgent", 
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 Agente+|lista|name=cod_agt;lookup=Agents
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 402, @_@_)',NULL,'Extend.js',TO_CLOB('SELECT p30.cod_ramo, a1800.NOM_RAMO, p30.num_poliza "NUM_PRESUPUESTO",  p30.fec_actu,
  LISTAGG(p20.txt_campo, '' - '') WITHIN GROUP (ORDER BY p20.num_secu) "DETALLE" , a1402.nom_fracc_pago "FRACCIONAMIENTO DE PAGO",
  CASE
  WHEN SYSDATE-p30.fec_actu<30 THEN ''Pendiente''
  ELSE ''Vencido''
END AS Vigencia
  ...
  group by p30.cod_ramo, a1800.NOM_RAMO, p30.num_poliza, p30.fec_actu,  a1402.nom_fracc_pago
  order by p30.fec_actu desc, p30.num_poliza,  a1402.nom_fracc_pago'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (333,1,1,'Presupuestos pendientes de emitir','Presupuestos pendientes de emitir por agente','PendingQuotationsToIssue',NULL,NULL,NULL,1,1,1,TIMESTAMP'2021-07-10 19:57:22',TO_CLOB('{
   "title": "Presupuestos pendientes de emitir",
   "table": {
      "entity": "PendingQuotationsToIssue", 
      "pagination": true,
      "search": true,
      "showToggle": false,
      "showRefresh": true,
   ...
   }'),'Research',1,NULL,NULL,'Extend.js',TO_CLOB('SELECT ID, PROPOSALID, INSUREDID, REPLACE(INSUREDID, ''-'', '''') INSUREDIDCLEAR, INSUREDNAME, SUMMARY, ISSUEDATE, SIGNINGREQUESTID, STATUS, LKS.DESCRIPTION STATUSDESC, SigningType, PrimaryEmailAddress
  FROM POLICYPROPOSAL
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (360,1,1,'Polizas activas','Polizas activas version 2','PolicyActiveV2',NULL,NULL,NULL,1,1,777,TIMESTAMP'2023-02-27 21:49:26',TO_CLOB('{
"title": "Polizas activas",
"table": {
"entity": "PolicyActiveV2",
"pagination": true,
"search": true,
"showToggle": false,
"showRefresh": true,
...
"halign": "center",
"align": "left",
"formatter": "app.ui.StringFo')||TO_CLOB('rmatter"
},
{
"field": "EMAIL",
"title": "Correo",
...
}'),'Tron',1,NULL,NULL,'Extend.Policy.js',TO_CLOB('SELECT distinct      a.cod_cia,            a.num_poliza,       b.num_riesgo,      a.num_poliza_anterior,
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (395,1,1,'Estado transacciones',NULL,'TransactionStatus',NULL,NULL,NULL,1,1,10509,TIMESTAMP'2022-05-31 00:00:00',TO_CLOB('{
...
}'),'Research',1,NULL,'transacciones',NULL,TO_CLOB('SELECT OLP.UPDATEDATE,OLP.REFERENCE,OLP.AUTHORIZATION, OLP.STATUSDATE, OLP.PROVIDERSTATUS, OLP.STATUS, S.DESCRIPTION, OLP.CURRENCY,C.EXTENDSTRINGVALUE1 NOM_MON, OLP.AMOUNT, OLP.POLICYID, OLP.BILLNUMBER
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (396,1,1,'Pólizas para Variaciones','Mis clientes - Agente conectado','PoliciesForVariations',NULL,NULL,NULL,1,1,777,TIMESTAMP'2024-10-22 21:49:26',TO_CLOB('{
  "title": "Polizas para Variaciones",
  "table": {
    "entity": "PoliciesForVariations",  
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
}'),'Tron',2,NULL,NULL,'Extend.Policy.js',TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_policy_by_agent_tomador_za {app.P_COD_CIA} {app.P_COD_AGT}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (400,1,1,'Avisos de cobro de un agente',NULL,'PaymentNoticesAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2022-06-02 00:00:00',TO_CLOB('{
  "title": "Avisos de cobro de un agente",
  "table": {
    "entity": "PaymentNoticesAgent",  
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
'),'Tron',1,NULL,'PaymentNoticesAgent','Extend.AvisosCobro.js',TO_CLOB('SELECT a.cod_docum_pago,a.FEC_VCTO_PAGO, a.tip_situacion estatus, COUNT(distinct a.num_recibo) cant_recibos, a.cod_mon, SUM(a.imp_recibo) total_recibos
  FROM a2990700 a
 WHERE a.cod_cia = 1
...
'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (401,1,1,'Recibos de un aviso de cobro',NULL,'BillsCollectionNotice',NULL,NULL,NULL,1,1,1,TIMESTAMP'2022-06-02 00:00:00',TO_CLOB('{
  "title": "Recibos de un aviso de cobro",
  "table": {
    "entity": "BillsCollectionNotice",
    "pagination": true,
    "search": true,
    "showToggle": true,
    "showRefresh": true,
    ...
    "columns": [
      ...
      {
        "field": "TIP_')||TO_CLOB('DOCUM",
        "title": "Tipo Identificacion Asegurado",
        "sortable": true,
        "halign": "center",
        "align": "left",
        "format": "{TIP_DOCUM}"
...
}'),'Tron',1,NULL,NULL,NULL,TO_CLOB('SELECT null Sel, {cod_docum_pago:varchar} cod_docum_pago, num_poliza, num_recibo, FEC_EFEC_RECIBO, tip_situacion, cod_mon, tip_docum, cod_docum, NOM_COMPLETO, nom_riesgo, sum(imp_recibo)
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (402,1,1,'Avisos de cobro por agente',NULL,'BillingNoticesFromAnAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2022-06-02 00:00:00',TO_CLOB('{
  "title": "Avisos de cobro de un agente",
  "table": {
    "entity": "BillingNoticesFromAnAgent",
    "pagination": true,
    "search": true,
    "showToggle": false,
    "showRefresh": true,
...
|zona|4
 Agente+|lista|name=cod_agt;lookup=Agents
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 402, @_@_)','BillingNoticesFromAnAgent','Extend.AvisosCobro.js',TO_CLOB('SELECT a.cod_docum_pago, a.tip_situacion estatus, COUNT(distinct a.num_recibo) cant_recibos, a.cod_mon, SUM(a.imp_recibo) total_recibos
  FROM a2990700 a
 WHERE a.cod_cia = 1
 ...
 order by a.cod_docum_pago desc'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (410,1,1,'Recibos pendientes de cobro por agente','Filtro','OutstandingBillsByAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2023-01-30 08:00:20',TO_CLOB('{
    "title": "Recibos pendientes",
    "table": {
        "entity": "OutstandingBillsByAgent",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 ...
 Desde+|fechainicio|default=today
 Hasta+|fechafin|default=today
 Filtrar|Boton|class=btn-form btn-primary btn-QueryFilter;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 11, @_@_)',NULL,'Extend.js
...
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (411,1,1,'Recibos cobrados por agente','Filtro','CollectedBillsByAgent',NULL,NULL,NULL,1,1,1,TIMESTAMP'2021-08-23 12:14:20',TO_CLOB('{
  "title": "Recibos cobrados",
  "table": {
        "entity": "CollectedBillsByAgent",
        "pagination": true,
        "search": true,
        "showToggle": false,
        "showRefresh": true,
...
|zona|4
 ...
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 318, @_@_)',NULL,NULL,TO_CLOB('em_k_Mapfre_Query_Contract_mcr.p_premium_collection {app.P_COD_CIA} {cod_agt} {mes} {anio}'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (412,1,1,'Polizas Activas MAPFRE Mas','Filtro','ActiveMapfrePlusPolicies',NULL,NULL,NULL,1,1,1,TIMESTAMP'2023-04-03 08:00:20',TO_CLOB('{
"title": "Polizas MAPFRE Mas",
"table": {
   "entity":"ActiveMapfrePlusPolicies",
   "pagination": true,
   "search": true,
   "showToggle": false,
   "showRefresh": true,
...
|zona|4
 Desde+|fechainicio|default=today
 Hasta+|fechafin|default=today
 Filtrar|Boton|class=btn-form btn-primary;click=app.ViewerQuery.Refresh(undefined, $(@_#RoleMemberGridTbl@_), 11, @_@_)','ActiveMapfrePlusPolicies','Extend.js',TO_CLOB('SELECT distinct a.cod_cia, a.num_poliza, a.num_poliza_grupo, a.num_contrato,    a.num_subcontrato,
       ...
       WHERE a.cod_cia            = {app.P_COD_CIA}
         ...
         ---Fraccionamiento de Pago
          ...
          --Prima
       ORDER BY a.num_poliza'));
INSERT INTO VISUALIZATIONS (ID,"SEQUENCE","TYPE",CAPTION,DESCRIPTION,ICON,ICONCLASS,VALUEFORMAT,ENTITYTYPE,RECORDSTATUS,COMPANYID,UPDATEUSERCODE,UPDATEDATE,SPECIFICATION,CONNECTIONNAME,STATEMENTTYPE,DIALOG,"KEY",JAVASCRIPTTOINCLUDE,"STATEMENT") VALUES (6000,1,1,'Polizas','Polizas','Policies',NULL,NULL,NULL,1,1,1,TIMESTAMP'2020-12-30 15:40:46',TO_CLOB('{
"title": "Polizas",
"table": {
    "entity": "Policies",
    "pagination": true,
...
Datos del riesgo|zona|columns=4|visible=entry.RAMO.neq.0
 ...
 Emitir|button|name=btnIssue|class=btn-on-primary','EmitirPoliza','Form.Ext.Altas.js',NULL);
