...
WHERE a399.COD_CIA=1 AND a399.COD_DOCUM={ID:VARCHAR2.20:Required}', 1, 'Custom', 'General', 1, NULL, 'Clentes', 'TRON', 0, NULL, NULL, NULL, NULL, 1, 0, 6329, TIMESTAMP '2023-06-13 00:00:00.000000');