INSERT INTO VISUALIZATIONS (ID, "SEQUENCE", "TYPE", CAPTION, DESCRIPTION, "STATEMENT", ICON, ICONCLASS, VALUEFORMAT, ENTITYTYPE, RECORDSTATUS, COMPANYID, UPDATEUSERCODE, UPDATEDATE, SPECIFICATION, CONNECTIONNAME, STATEMENTTYPE, DIALOG, STATEMENTEXTEND, "KEY", JAVASCRIPTTOINCLUDE) VALUES(350, 1, 1, 'Siniestros', 'Siniestros por agente', 'SELECT a900.NUM_SINI, a80.OBS ASIGES, a900.TIP_EST_SINI, G31A.NOM_VALOR NOM_TIP_EST_SINI, a900.FEC_DENU_SINI,a900.HORA_DENU_SINI, a900.FEC_SINI, a900.HORA_SINI, a900.COD_CAUSA_SINI, G200.NOM_CAUSA, a900.FEC_TERM_SINI, a900.FEC_REAP_SINI, a900.MCA_CULPABLE,a900.TIP_APERTURA,
 ...
 ORDER BY a900.FEC_SINI DESC', NULL, NULL, NULL, NULL, 1, 1, 1, TIMESTAMP '2021-01-23 12:18:19.000000', '{
  "title": "Siniestros",
  "table": {
    "pagination": true,
    "search": true,
    ...
    "columns": [{
      ...
      },
      {
        ...
        "halign": "center",
        "align": "left",
        "formatter": "app.ExtendClaims.NOM_ASEGFormatter"
      },
      {
...
INSERT INTO VISUALIZATIONS (ID, "SEQUENCE", "TYPE", CAPTION, DESCRIPTION, "STATEMENT", ICON, ICONCLASS, VALUEFORMAT, ENTITYTYPE, RECORDSTATUS, COMPANYID, UPDATEUSERCODE, UPDATEDATE, SPECIFICATION, CONNECTIONNAME, STATEMENTTYPE, DIALOG, STATEMENTEXTEND, "KEY", JAVASCRIPTTOINCLUDE) VALUES(351, 1, 1, 'Expedientes', 'Expedientes del siniestro', 'SELECT a1000.NUM_SINI, a1000.NUM_EXP, a1000.TIP_EXP, G90.NOM_EXP,a1000.FEC_APER_EXP, a1000.FEC_TERM_EXP,  a1000.TIP_EST_EXP, G31A.NOM_VALOR NOM_TIP_EST_EXP,
 ...
 WHERE a1000.COD_CIA={app.p_cod_cia} AND a1000.NUM_SINI={num_sini} ORDER BY a1000.NUM_EXP', NULL, NULL, NULL, NULL, 1, 1, 1, TIMESTAMP '2021-01-24 22:30:14.000000', '{
