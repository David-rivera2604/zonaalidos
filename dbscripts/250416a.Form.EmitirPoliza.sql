UPDATE VISUALIZATIONS SET "TYPE"=9, CAPTION='Emitir una póliza', DESCRIPTION='Form', ICON=NULL, ICONCLASS=NULL, VALUEFORMAT=NULL, ENTITYTYPE=NULL, RECORDSTATUS=1, COMPANYID=1, UPDATEUSERCODE=777, UPDATEDATE=TIMESTAMP '2023-02-27 00:00:00.000000', SPECIFICATION=NULL, CONNECTIONNAME=NULL, STATEMENTTYPE=NULL, DIALOG='Emisión de una pólizas|título
...
Datos del riesgo|zona|columns=4|visible=entry.RAMO.neq.0
 ...
 Sueldo del asegurado+|decimal(18,3)|name=IMP_SUMA_ASEG_VC|visible=entry.RAMO.eq.117
 ...
 Emitir|button|name=btnIssue|class=btn-on-primary', STATEMENTEXTEND=NULL, "KEY"='EmitirPoliza', JAVASCRIPTTOINCLUDE='Form.Ext.Altas.js', "STATEMENT"=NULL WHERE ID=9105 AND "SEQUENCE"=1;