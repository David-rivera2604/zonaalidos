    ...
    public static class Consultas
    {
        ...
        public async static Task<Architect.API.Insurance.Contracts.Policy.Insured> RiskRoles(string identificacion)
        {
            ...
            try
            {
                ...
                Database.Select("SELECT DocumentType, DocumentNumber, FirstName, MiddleName, LastName, SecondLastName, BirthDate, Gender, CivilStatus, PrimaryEmailAddress, Province, Canton, District, AddressDetail, PhoneType, PhoneNumber " +
                                  "FROM RiskRoles " +
