...
namespace Architect.API.Tron.Business.HogarTotal.Handler
{
    ...
    public static class Quote
    {
        ...
        /// </summary>
        public static Contracts.Cotizacion.HogarTotal Setup(int cod_ramo, Core.Contracts.Security.Token tokenInfo)
        {
            ...
            bool IsCoope = false;
            int cod_cia = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.cod_cia"]);
        ...
        /// </summary>
        public static Contracts.Cotizacion.HogarTotal Apply(Contracts.Cotizacion.HogarTotal quoteInfo, Core.Contracts.Security.Token tokenInfo)
        {
            ...
            if (resultInfo.Errors.Count == 0)
            {
                ...
                Architect.API.Tron.Contracts.Presupuesto.DatoFijo result = Convert.QuoteToPresupuesto.Tron(quoteInfo, IsCoope, quoteInfo.cod_ramo, tokenInfo.AgentCode, tokenInfo.UserName);
...
//                Utilities.SerializeHandler<Architect.API.Tron.Contracts.Presupuesto.DatoFijo>.SerializeJSONToFile(result, string.Format(@"c:\temp\hogar.total.proposal.json"), true, false, false);
                ...
                resultInfo = LookupComplements( Convert.PresupuestoToQuote.Quote(quoteInfo, result), tokenInfo);
                ...
                {
                    Core.Business.General.ChangeSet.Create(3000, System.Convert.ToInt32(resultInfo.presupuesto.Substring(4)), tokenInfo.CompanyId, "Cotización Hogar Total", "Presupuesto #" + resultInfo.presupuesto, tokenInfo.UserId, resultInfo);
                }
