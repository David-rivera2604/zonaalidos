...
namespace Architect.API.Tron.Business.HogarTotal.Convert
{
    internal static class IssueToPresupuesto
    {
        ...
        internal static Architect.API.Tron.Contracts.Presupuesto.DatoFijo DatosFijos(Contracts.Emision.HogarTotal quoteInfo, int branch)
        {
            ...
            {
                cod_cia = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.cod_cia"]),
                num_poliza = quoteInfo.presupuesto,
                num_spto = 0,
                num_apli = 0,
                num_spto_apli = 0,
                cod_sector = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.HogarTotal.cod_sector"]),
                cod_ramo = branch,
                ...
                cod_org = 0,
                cod_asesor = 0,
                cod_nivel1 = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.cod_nivel1"]),
                cod_nivel2 = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.cod_nivel2"]),
                cod_nivel3 = System.Convert.ToInt32(ConfigurationManager.AppSettings["Mapfre.Tron.cod_nivel3"]),
                cod_compensacion = 0,
                pct_regulariza = 0,
                cod_indice = 0,
        ...
        internal static List<Architect.API.Tron.Contracts.Presupuesto.DatoVariable> DatosVariable(Contracts.Emision.HogarTotal quoteInfo, Architect.API.Tron.Contracts.Presupuesto.DatoFijo datosFijos)
        {
            ...
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "TIP_PLAN_ASIST", System.Convert.ToString(propiedad.tipoplan), 3, 99, ""));
