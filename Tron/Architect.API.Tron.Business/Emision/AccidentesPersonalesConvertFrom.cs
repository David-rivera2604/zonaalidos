...
{
    public static class AccidentesPersonalesConvertFrom
    {
        public static Contracts.Emision.AccidentesPersonales Quote(Contracts.Emision.AccidentesPersonales quoteInfo, Architect.API.Tron.Contracts.Poliza.DatoFijo tronQuoteInfo)
        {
