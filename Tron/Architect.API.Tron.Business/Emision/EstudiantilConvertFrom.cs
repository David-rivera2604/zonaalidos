...
{
    public static class EstudiantilConvertFrom
    {
        public  static Contracts.Emision.Estudiantil Quote(Contracts.Emision.Estudiantil quoteInfo, Architect.API.Tron.Contracts.Poliza.DatoFijo tronQuoteInfo)
        {
