...
namespace Architect.API.Tron.Business.Emision
{
    ...
    {
        internal static Contracts.Emision.HogarTotal Quote(Contracts.Emision.HogarTotal quoteInfo, Architect.API.Tron.Contracts.Poliza.DatoFijo tronQuoteInfo)
        {
            ...
            if (tronQuoteInfo.Calculado?.Coberturas != null)
            {
                ...
                {
                    foreach (Architect.API.Tron.Contracts.Cotizacion.coberturas itemQuote in quoteInfo.coberturas)
                    {
            ...
            if (tronQuoteInfo.Calculado?.Recibos != null)
            {
                ...
                bool setvalues = true;
                quoteInfo.plandepago = new List<Contracts.Cotizacion.plandepago>();
                foreach (Architect.API.Tron.Contracts.Poliza.ReciboCalculado item in tronQuoteInfo.Calculado.Recibos)
                {
                    ...
                    quoteInfo.plandepago.Add(new Contracts.Cotizacion.plandepago()
                    {
                        ...
                        iVA = item.IMP_IMPTOS,
                        recardoporfraccionamiento = item.IMP_RECARGO,
