...
{
    internal static class AccidentesPersonalesConvertTo
    {
        internal static Contracts.Presupuesto.DatoFijo Tron(Contracts.Emision.AccidentesPersonales quoteInfo)
        {
        ...
        internal static Contracts.Presupuesto.DatoFijo DatosFijos(Contracts.Emision.AccidentesPersonales quoteInfo, int branch)
        {
        ...
        internal static List<Contracts.Presupuesto.DatoVariable> DatosVariable(Contracts.Emision.AccidentesPersonales quoteInfo, Contracts.Presupuesto.DatoFijo datosFijos)
        {
        ...
        internal static List<Contracts.Presupuesto.Tercero> Terceros(Contracts.Emision.AccidentesPersonales quoteInfo, Contracts.Presupuesto.DatoFijo datosFijos)
        {
