...
namespace Architect.API.Tron.Business.Variaciones
{
    public static class HogarTotal
    {
        ...
        public static Contracts.Variaciones.HogarTotal Setup(string num_poliza, int num_spto, string mca_provisional, Core.Contracts.Security.Token tokenInfo)
        {
            Contracts.Variaciones.HogarTotal result = null;
            ...
            Contracts.Variaciones.HogarTotal resultInfo2 = Variaciones.HogarTotalConvertFrom.Quote(Variaciones.HogarTotalConvertFrom.Quote(A30Instance), A30Instance);
            ...
            {
                result = Newtonsoft.Json.JsonConvert.DeserializeObject<Contracts.Variaciones.HogarTotal>(Utilities.Cache.GetItem(key).ToString());
        ...
        public static VariacionIssueResult Issue(Contracts.Variaciones.HogarTotal quoteInfo)
        {
            return VariacionesServiceCommon.Issue(quoteInfo);
        }

        public static VariacionIssueResult Cancelation(Contracts.Variaciones.HogarTotal quoteInfo)
        {
