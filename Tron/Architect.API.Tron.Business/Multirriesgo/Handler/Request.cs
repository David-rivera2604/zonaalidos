...
namespace Architect.API.Tron.Business.Multirriesgo.Handler
{
    public static class Request
    {
        ...
        internal static string EnviarSolicitud(string tip_firma, string correoenvio, Contracts.Emision.Multirriesgo quoteInfo, Core.Contracts.Security.Token tokenInfo)
        {
        ...
        internal static Contracts.Emision.EconomicData EconomicDataCalculate(Contracts.Cotizacion.Multirriesgo quoteInfo)
        {
