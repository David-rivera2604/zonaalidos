    ...
    public class GeneratedPDF
    {
        public string GeneratePDF(dynamic datos, Core.Contracts.Security.Token tokenInfo)
        {
            ...
            if (datos is Contracts.Emision.MultirriesgoSolicitud)
            {
                ...
                if (tokenInfo.Roles.Contain("PolizaGrupo") && !(multirriesgoSolicitud.polizagrupo != string.Empty || multirriesgoSolicitud.polizagrupo != null || 
                                                                multirriesgoSolicitud.polizagrupo != "2022410120214"))
                {
            ...
            else if (datos is Contracts.Emision.HogarTotalSolicitud)
            {
                ...
                else if (tokenInfo.Roles.Contain("PolizaGrupo") && !(hogartotalSolicitud.polizagrupo != string.Empty || hogartotalSolicitud.polizagrupo != null ||
                                                                     hogartotalSolicitud.polizagrupo != "2012410199312" || hogartotalSolicitud.polizagrupo != "2012410199320")) // Poliza Grupo
                    {
