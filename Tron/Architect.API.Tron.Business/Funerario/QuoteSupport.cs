...
{
    /// <summary>
    /// Provee funciones auxiliares para construir datos de cotización funeraria y mapear estructuras hacia Tron.
    /// </summary>
    internal class QuoteSupport
    {

        /// <summary>
        /// Recupera y marca la configuración de coberturas por defecto del ramo/modalidad configurados.
        /// </summary>
        /// <param name="cod_cia">Código de compañía.</param>
        /// <param name="cod_ramo">Código de ramo.</param>
        /// <param name="fec_validez">Fecha de validez para consultar coberturas.</param>
        /// <returns>Lista de coberturas con selección y montos iniciales.</returns>
        ...
        /// <summary>
        /// Convierte un tercero de cotización al formato de tercero de presupuesto Tron.
        /// </summary>
        /// <param name="datosFijos">Contenedor de datos fijos del presupuesto.</param>
        /// <param name="item">Tercero origen de la cotización.</param>
        /// <param name="tipodetercero">Tipo de tercero destino a aplicar.</param>
        /// <returns>Tercero transformado al esquema de presupuesto.</returns>
        ...
        /// <param name="datosFijos">Datos fijos del presupuesto.</param>
        /// <returns>Listado de datos variables listos para envío a Tron.</returns>
