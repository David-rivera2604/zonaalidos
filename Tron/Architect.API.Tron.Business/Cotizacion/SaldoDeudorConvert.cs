...
namespace Architect.API.Tron.Business.Cotizacion
{
    internal static class SaldoDeudorConvert
    {
        ...
        private static List<Contracts.Presupuesto.DatoVariable> DatosVariable(Contracts.Cotizacion.SaldoDeudor quoteInfo, Contracts.Presupuesto.DatoFijo datosFijos)
        {
            ...
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "NUM_POLIZA_ORI", quoteInfo.NUM_POLIZA_ORI.ToString(), 2, 5));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "IMP_MONTO_ORI", quoteInfo.IMP_MONTO_ORI.ToString(), 2, 6));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "IMP_SLD_ACTUAL", quoteInfo.IMP_SLD_ACTUAL.ToString(), 2, 7));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "NUM_PRESTAMO", quoteInfo.NUM_PRESTAMO, 2, 9));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "FEC_NACIMIENTO", quoteInfo.FEC_NACIMIENTO.ToString(("ddMMyyyy")), 2, 14));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "MCA_SEXO", quoteInfo.MCA_SEXO, 2, 15, quoteInfo.MCA_SEXO));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "NUM_EDAD_ASEGURADO", quoteInfo.FEC_NACIMIENTO.Age().ToString(), 2, 16));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "TIP_NEGOCIO", quoteInfo.TIP_NEGOCIO, 2, 17, quoteInfo.NOM_TIP_NEGOCIO));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "IMP_PRIMA_INFORMADA", quoteInfo.IMP_PRIMA_INFORMADA.ToString(), 2, 18));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "IMP_GASTOS_EMISION", quoteInfo.IMP_GASTOS_EMISION.ToString(), 2, 36));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "PCT_DTO_COMERCIAL", quoteInfo.PCT_DTO_COMERCIAL.ToString(), 2, 32));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "PCT_DCTO_TECNICO", quoteInfo.PCT_DCTO_TECNICO.ToString(), 2, 28));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "NUM_ENF_EXC", quoteInfo.enfermedadesexcluidas.Count().ToString(), 2, 35));
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "FEC_PRIM_FINAN", quoteInfo.FEC_PRIM_FINAN.ToString("ddMMyyyy"), 2, 10));
            ...
            datosVariables.Add(Util.DatoVariable(datosFijos, num_riesgo, "COD_MODALIDAD", quoteInfo.COD_MODALIDAD_RIESGO.ToString(), 2, 34, quoteInfo.NOM_MODALIDAD_RIESGO));
