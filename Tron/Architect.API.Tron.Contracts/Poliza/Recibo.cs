...
namespace Architect.API.Tron.Contracts.Poliza
{
    ...
    public partial class Recibo
    {
        ...
        /// <summary>
        ///  Tipo de remesa para control de saldos(0-ambos, 1-primas, 2-otros .... )
        /// </summary>
        ...
        /// <summary>
        ///  Para el asiento de emisión o fecha de pago
        /// </summary>
        ...
        /// <summary>
        ///  Total de la comisión del recibo
        /// </summary>
        ...
        /// <summary>
        ///  Fecha vencimiento de pago (ultimo día de gracia)
        /// </summary>
        public DateTime fec_vcto_pago { get; set; }

        /// <summary>
        ///  Número de secuencia para los cambios de agente (rompe la pk en la anulación de recibos a regenerar)
        /// </summary>
        public int num_mvto_ca { get; set; }
    }
}