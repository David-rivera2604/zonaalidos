...
namespace Architect.API.Tron.DataAccess
{
    ...
    /// <summary>
    /// EM_K_COTIZADOR_WEB_302_MCR
    /// </summary>
    public static class CotizadorMapfreMasClass
    {
        public static Architect.API.Tron.Contracts.Presupuesto.DatoFijo P_Cotiza(Architect.API.Tron.Contracts.Batch.CotizadorMapfreMasClass p2000030Instance, IDbConnection currentConnection)
        {
            ...
            Database.Procedure("EM_K_COTIZADOR_WEB_302_MCR.P_COTIZA")
                ...
                .AddParameter("P_PCT_AJUSTE_GEN", Architect.DataFactory.Enumerations.DbType.Int32, 22, p2000030Instance.pct_ajuste_gen)
                ...
                .AddParameter("P_COD_TIP_COM_VEHI", Architect.DataFactory.Enumerations.DbType.String, 3, p2000030Instance.COD_TIP_COM_VEHI)
                .AddParameter("P_RC_ALCOHOL", Architect.DataFactory.Enumerations.DbType.String, 1, p2000030Instance.rc_alcohol)
                .AddParameter("P_RC_CONDUCTOR", Architect.DataFactory.Enumerations.DbType.String, 1, p2000030Instance.rc_conductor)
