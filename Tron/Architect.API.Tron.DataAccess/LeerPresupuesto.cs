...
{
    public static class LeerPresupuesto
    {

        public static Architect.API.Tron.Contracts.Presupuesto.DatoFijo Presupuesto(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection, bool loadChilds, string filter = "full")
        {
            ...
            if (loadChilds)
            {
                if (filter == "full")
                {
                    result.Riesgos = PP_Lee_P2000031(cod_cia, num_poliza, num_spto, num_apli, num_spto_apli, currentConnection);
                    result.DatosVariables = PP_Lee_P2000020(cod_cia, num_poliza, num_spto, num_apli, num_spto_apli, currentConnection);
                    result.Ocurrencias = PP_Lee_P2000025(cod_cia, num_poliza, num_spto, num_apli, num_spto_apli, currentConnection);
                    result.Terceros = PP_Lee_P2000060(cod_cia, num_poliza, num_spto, num_apli, num_spto_apli, currentConnection);
                }
        ...
        /// </summary>
        private static Architect.API.Tron.Contracts.Presupuesto.DatoFijo PP_Lee_P2000030(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            Architect.API.Tron.Contracts.Presupuesto.DatoFijo result = null;
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000030")
                                           ...
                                           {
                                               result = new Architect.API.Tron.Contracts.Presupuesto.DatoFijo()
                                               {
                                                   ...
                                                   num_poliza_tr = reader.StringValue("num_poliza_tr"),
                                                   imp_cuota_inicial = reader.StringValue("imp_cuota_inicial"),
        ...
        /// </summary>
        private static List<Architect.API.Tron.Contracts.Presupuesto.Riesgo> PP_Lee_P2000031(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.Riesgo> result = new List<Architect.API.Tron.Contracts.Presupuesto.Riesgo>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000031")
               .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
               .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
               .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
               .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
               ...
               .Query(currentConnection, new Action<IDataReader>((reader) =>
               {
                   result.Add(new Architect.API.Tron.Contracts.Presupuesto.Riesgo()
                   {
                       cod_cia = reader.IntegerValue("cod_cia"),
                       num_poliza = reader.StringValue("num_poliza"),
                       num_spto = reader.IntegerValue("num_spto"),
        ...
        /// </summary>
        private static List<Architect.API.Tron.Contracts.Presupuesto.DatoVariable> PP_Lee_P2000020(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.DatoVariable> result = new List<Architect.API.Tron.Contracts.Presupuesto.DatoVariable>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000020")
                                           .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
                                           .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
                                           .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
                                           .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
                                           ...
                                           .Query(currentConnection, new Action<IDataReader>((reader) =>
                                           {
                                               result.Add(new Architect.API.Tron.Contracts.Presupuesto.DatoVariable()
                                               {
                                                   cod_cia = reader.IntegerValue("cod_cia"),
                                                   num_poliza = reader.StringValue("num_poliza"),
                                                   num_spto = reader.IntegerValue("num_spto"),
        ...
        /// </summary>
        private static List<Architect.API.Tron.Contracts.Presupuesto.Ocurrencia> PP_Lee_P2000025(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.Ocurrencia> result = new List<Architect.API.Tron.Contracts.Presupuesto.Ocurrencia>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000025")
                                           .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
                                           .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
                                           .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
                                           .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
                                           ...
                                           .Query(currentConnection, new Action<IDataReader>((reader) =>
                                           {
                                               result.Add(new Architect.API.Tron.Contracts.Presupuesto.Ocurrencia()
                                               {
                                                   cod_cia = reader.IntegerValue("cod_cia"),
                                                   num_poliza = reader.StringValue("num_poliza"),
                                                   num_spto = reader.IntegerValue("num_spto"),
        ...
        /// </summary>
        private static List<Architect.API.Tron.Contracts.Presupuesto.Cobertura> PP_Lee_P2000040(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.Cobertura> result = new List<Architect.API.Tron.Contracts.Presupuesto.Cobertura>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000040")
                .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
                .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
                .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
                .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
                ...
                .Query(currentConnection, new Action<IDataReader>((reader) =>
                {
                    result.Add(new Architect.API.Tron.Contracts.Presupuesto.Cobertura()
                    {
                        cod_cia = reader.IntegerValue("cod_cia"),
                        num_poliza = reader.StringValue("num_poliza"),
                        num_spto = reader.IntegerValue("num_spto"),
                        ...
                        pct_participacion = reader.DoubleValue("pct_participacion"),
                        cod_mon_capital = reader.IntegerValue("cod_mon_capital"),
                        suma_aseg_baja_stro = reader.DoubleValue("suma_aseg_baja_stro"),
                        ...
                        suma_aseg_sup = reader.DoubleValue("suma_aseg_sup"),
                        mca_baja_riesgo = reader.StringValue("mca_baja_riesgo"),
                        mca_vigente = reader.StringValue("mca_vigente"),
                        mca_vigente_apli = reader.StringValue("mca_vigente_apli"),
                        mca_baja_cob = reader.StringValue("mca_baja_cob"),
                        cod_secc_reas = reader.IntegerValue("cod_secc_reas"),
                        imp_agr = reader.DoubleValue("imp_agr"),
                        imp_agr_rel = reader.DoubleValue("imp_agr_rel"),
                        imp_agr_spto = reader.DoubleValue("imp_agr_spto"),
                        imp_agr_rel_spto = reader.DoubleValue("imp_agr_rel_spto"),
                        mes_base_regulariza = reader.IntegerValue("mes_base_regulariza"),
                        anio_base_regulariza = reader.IntegerValue("anio_base_regulariza"),
                        pct_enfermedad = reader.DoubleValue("pct_enfermedad"),
                        duracion_profesion = reader.IntegerValue("duracion_profesion"),
                        pct_profesion = reader.DoubleValue("pct_profesion"),
                        duracion_enfermedad = reader.IntegerValue("duracion_enfermedad"),
                        val_franquicia_min = reader.DoubleValue("val_franquicia_min"),
                        val_franquicia_max = reader.DoubleValue("val_franquicia_max"),
                        cod_ramo = reader.IntegerValue("cod_ramo"),
                        suma_aseg_baja_stro_acc = reader.DoubleValue("suma_aseg_baja_stro_acc"),
        ...
        /// </summary
        private static List<Architect.API.Tron.Contracts.Presupuesto.Tercero> PP_Lee_P2000060(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.Tercero> result = new List<Architect.API.Tron.Contracts.Presupuesto.Tercero>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2000060")
                        .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
                        .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
                        .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
                        .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
                        ...
                        .Query(currentConnection, new Action<IDataReader>((reader) =>
                        {
                            result.Add(new Architect.API.Tron.Contracts.Presupuesto.Tercero()
                            {
                                cod_cia = reader.IntegerValue("cod_cia"),
                                num_poliza = reader.StringValue("num_poliza"),
                                num_spto = reader.IntegerValue("num_spto"),
        ...
        /// <summary>
        ///  Recibos/cuotas del presupuesto
        /// </summary>
        private static List<Architect.API.Tron.Contracts.Presupuesto.Recibo> PP_Lee_P2990700(int cod_cia, string num_poliza, int num_spto, int num_apli, int num_spto_apli, IDbConnection currentConnection)
        {
            List<Architect.API.Tron.Contracts.Presupuesto.Recibo> result = new List<Architect.API.Tron.Contracts.Presupuesto.Recibo>();
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_P2990700")
                .AddParameter("P_COD_CIA", Architect.DataFactory.Enumerations.DbType.Int32, 22, cod_cia)
                .AddParameter("P_NUM_POLIZA", Architect.DataFactory.Enumerations.DbType.String, 13, num_poliza)
                .AddParameter("P_NUM_SPTO", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_spto)
                .AddParameter("P_NUM_APLI", Architect.DataFactory.Enumerations.DbType.Int32, 22, num_apli)
                ...
                .Query(currentConnection, new Action<IDataReader>((reader) =>
                {
                    result.Add(new Architect.API.Tron.Contracts.Presupuesto.Recibo()
                    {
                        cod_cia = reader.IntegerValue("cod_cia"),
                        num_poliza = reader.StringValue("num_poliza"),
                        num_spto = reader.IntegerValue("num_spto"),
                        ...
                        cod_mon = reader.IntegerValue("cod_mon"),
                        val_cambio = reader.IntegerValue("val_cambio"),
                        imp_recibo = reader.DoubleValue("imp_recibo"),
                        imp_neta = reader.IntegerValue("imp_neta"),
                        imp_recargo = reader.IntegerValue("imp_recargo"),
                        imp_imptos = reader.DoubleValue("imp_imptos"),
                        imp_boni = reader.IntegerValue("imp_boni"),
                        imp_comis = reader.IntegerValue("imp_comis"),
                        tip_coaseguro = reader.IntegerValue("tip_coaseguro"),
                        cod_nivel3 = reader.IntegerValue("cod_nivel3"),
                        cod_agt = reader.IntegerValue("cod_agt"),
                        ...
                        fec_actu = reader.DateTimeValue("fec_actu"),
                        imp_total_comis = reader.IntegerValue("imp_total_comis"),
