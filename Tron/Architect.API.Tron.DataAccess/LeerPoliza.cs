            ...
            Database.Procedure("EM_K_MAPFRE_BATCH_CONTRACT_MCR.PP_LEE_A2990700")
                                           ...
                                           .Query(currentConnection, new Action<IDataReader>((reader) =>
                                           {
                                               result.Add(new Architect.API.Tron.Contracts.Poliza.Recibo()
                                               {
                                                   ...
                                                   imp_recibo = reader.IntegerValue("imp_recibo"),
                                                   imp_neta = reader.IntegerValue("imp_neta"),
                                                   imp_recargo = reader.IntegerValue("imp_recargo"),
                                                   imp_imptos = reader.IntegerValue("imp_imptos"),
                                                   ...
                                                   imp_interes = reader.IntegerValue("imp_interes"),
                                                   imp_imptos_interes = reader.IntegerValue("imp_imptos_interes"),
