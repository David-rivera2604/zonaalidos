...
FROM (SELECT COD_CIA, '0' AS TIP_BENEF, TIP_DOCUM, COD_DOCUM FROM a2000030 a30 WHERE NUM_POLIZA = :NUM_POLIZA
      UNION
      SELECT COD_CIA, TIP_BENEF, TIP_DOCUM, COD_DOCUM FROM A2000060 a60 WHERE COD_CIA =1 AND NUM_POLIZA = :NUM_POLIZA AND TIP_BENEF = 21 ORDER BY 1 DESC) terc 
...
SELECT a30.COD_RAMO, a1800.nom_ramo, a200.NOM_SECTOR, a30.TIP_DOCUM, a30.COD_DOCUM, a1331.NOM_TERCERO, a1331.NOM2_TERCERO, a1331.APE1_TERCERO, a1331.APE2_TERCERO, a1331.email, a1331.TXT_EMAIL, a1331.tlf_numero, a1331.TLF_MOVIL, a700.cod_mon, SUM(a700.imp_recibo) imp_recibo, a1331.TIP_TARJETA, a1331.COD_TARJETA, a1331.NUM_TARJETA
  FROM a2000030 a30
  ...
  JOIN TERCEROS a1331 ON a1331.COD_CIA=a30.COD_CIA AND a1331.TIP_DOCUM = a30.TIP_DOCUM AND a1331.COD_DOCUM = a30.COD_DOCUM
...
@" AND a30.mca_spto_anulado   = 'N'
 ...
 GROUP BY a30.COD_RAMO, a1800.nom_ramo, a200.NOM_SECTOR, a30.TIP_DOCUM, a30.COD_DOCUM, a1331.NOM_TERCERO, a1331.NOM2_TERCERO, a1331.APE1_TERCERO, a1331.APE2_TERCERO, a1331.email, a1331.TXT_EMAIL, a1331.tlf_numero, a1331.TLF_MOVIL, a700.cod_mon, a1331.TIP_TARJETA, a1331.COD_TARJETA, a1331.NUM_TARJETA")
