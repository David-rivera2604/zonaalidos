...
SELECT DISTINCT B.REASON,A99.MCA_FISICO, A99.TIP_DOCUM, A99.COD_DOCUM, A99.NOM_TERCERO, A99.NOM2_TERCERO, A99.APE1_TERCERO, A99.APE2_TERCERO, 
       ...
       TJ.TIP_TARJETA, A21.NOM_TIP_TARJETA, TJ.COD_TARJETA, A22.NOM_TARJETA, NTM.NUM_TARJETA_ORIGINAL NUM_TARJETA, TJ.FEC_VCTO_TARJETA,
  ...
  LEFT JOIN NUM_TARJETA_MCR NTM ON NTM.COD_CIA=A99.COD_CIA AND NTM.TIP_DOCUM=A99.TIP_DOCUM AND NTM.COD_DOCUM=A99.COD_DOCUM AND NTM.FEC_ACTU IN (SELECT MAX(FEC_ACTU) FROM NUM_TARJETA_MCR NTM WHERE NTM.COD_CIA=A99.COD_CIA AND NTM.TIP_DOCUM=A99.TIP_DOCUM AND NTM.COD_DOCUM=A99.COD_DOCUM)
