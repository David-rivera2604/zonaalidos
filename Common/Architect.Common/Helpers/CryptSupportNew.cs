...
namespace Architect.Common.Helpers
{
    ...
    public class CryptSupportNew
    {
        ...
        /// </summary>
        /// <param name="textPlaint">Text decrypt/Texto a descriptor</param>
        /// <returns></returns>
        /// <remarks></remarks>
        ...
        private static string EncryptStringToBytes_Aes(string plainText, byte[] Key, int Size)
        {
            ...
            using (var aesAlg = Aes.Create())
            {
                ...
                aesAlg.Key = keys.GetBytes((int)(aesAlg.KeySize / 8d));
                aesAlg.IV = keys.GetBytes((int)(aesAlg.BlockSize / 8d));
