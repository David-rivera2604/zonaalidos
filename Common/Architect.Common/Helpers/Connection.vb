...
Namespace Helpers
    ...
    Public Class Connection
        ...
        Public Shared Function GetIPEnviroment() As String
            Try
                If IsLocalIpAddress() Then
                    Return Architect.Common.Helpers.Connection.NameHostFromIp(Architect.Common.Helpers.Connection.GetIPOnlyRequest())
                Else
        ...
        Public Shared Function UserHostAddress() As String
