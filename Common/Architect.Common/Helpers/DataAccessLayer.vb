...
#Region "Public Members"
        ...
        Public Function ExecuteQuery(ByVal query As String, ByVal repositoryName As String) As DataTable
            Dim result As DataTable = Nothing

            If IsNothing(_dbConnection) Then
                _dbConnection = OpenDbConnection(repositoryName)
            End If
            ...
            If Not IsNothing(_dbConnection) Then
                ...
                Dim dataReaderItem As DbDataReader = DataAccessLayer.QueryExecute(commandItem, _dbConnection, CommandBehavior.Default, "Dynamic")
        ...
        Public Function ExecuteQueryScalar(ByVal query As String, ByVal repositoryName As String) As Integer
        ...
        Public Function ProcedureExecuteWithDataTableResultset(ByVal storedProcedureName As String, ByVal parameterList As List(Of DataType.Parameter), ByVal repositoryName As String) As DataTable
            Dim result As DataTable = Nothing
...
#Region "Shared Members"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Public Shared Function QueryExecuteToTableJSON(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, returnEmptyDataTable As Boolean) As DataTable
            Return QueryExecuteToTable(command, currentConnection, behavior, table, returnEmptyDataTable)
        End Function

        Public Shared Function QueryExecuteToTable(statement As String, currentConnection As DbConnection, behavior As CommandBehavior, table As String) As DataTable
            Dim result As DataTable = Nothing
        ...
        Public Shared Function QueryExecuteToTable(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String, returnEmptyDataTable As Boolean) As DataTable
            Dim result As DataTable = Nothing
            ...
            Else
                If dataReaderItem.HasRows OrElse
                   returnEmptyDataTable Then
                    ...
                    result.TableName = table
                    watch.Stop()
                    If ConfigurationManager.AppSettings("DataAccessLayer.Debug").IsNotEmpty AndAlso
                       ConfigurationManager.AppSettings("DataAccessLayer.Debug").Equals("True", StringComparison.CurrentCultureIgnoreCase) Then
                        Message = Message + String.Format("              Time retrieve={0} ms", watch.ElapsedMilliseconds)
                        Message = Message + Environment.NewLine + String.Format("              Rows={0}", result.Rows.Count)
                        LogHandler.TraceLog("DataAccessLayer",
                                            Message)
                    End If
                End If
            End If
        ...
        Public Shared Function QueryExecuteToTable(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String) As DataTable
            Return QueryExecuteToTable(command, currentConnection, behavior, table, False)
        End Function

        Public Shared Function QueryExecuteToTableString(command As DbCommand, currentConnection As DbConnection, behavior As CommandBehavior, table As String) As String
            Dim dTable As DataTable = QueryExecuteToTable(command, currentConnection, behavior, table)
                    ...
                    If ConfigurationManager.AppSettings("DataAccessLayer.Debug").IsNotEmpty AndAlso
                       ConfigurationManager.AppSettings("DataAccessLayer.Debug").Equals("True", StringComparison.CurrentCultureIgnoreCase) Then
                        ...
                        If Not IsRetrieve Then
                            messageInternal &= vbCrLf & String.Format("              HasRows={0}", result.HasRows)
                        End If
                        messageInternal &= vbCrLf & String.Format("              Time Execution={0} ms", watch.ElapsedMilliseconds)
                        If ConfigurationManager.AppSettings("DataAccessLayer.Debug.DetailsCall").IsNotEmpty AndAlso
                            ConfigurationManager.AppSettings("DataAccessLayer.Debug.DetailsCall").Equals("True", StringComparison.CurrentCultureIgnoreCase) Then

                            Dim detailsCall As String
                            If Not IsRetrieve Then
                                detailsCall = AssemblyHandler.GetFrameProcess(5)
                            Else
                                detailsCall = AssemblyHandler.GetFrameProcess(6)
                            End If

                            If detailsCall.IsNotEmpty Then
                                messageInternal &= vbCrLf & String.Format("{0}", detailsCall.ToString.Replace("<<I>>", "              "))
                            End If
                ...
                Catch exOracle As OracleException
                    ...
                    Else
                        ...
                        If currentConnection.State = ConnectionState.Open Then
                            currentConnection.Close()
                        End If
                        Throw ExceptionOracleProcess(exOracle, command, table, "Query")
                    End If
        ...
        Private Shared Function ExceptionOracleProcess(exOracle As OracleException, command As DbCommand, nameObject As String, commandKind As String) As Exceptions.DataAccessException
            ...
            Select Case code
                ...
                Case 28000
                    exceptionTemporal = New Exceptions.DataAccessException("The account is locked, This happens for several attempts with the user or incorrect password, please contact your database administrator", exOracle, command, nameObject, commandKind)
                        'ORA-01017: Invalid username/password; logon denied
                Case 1017
                    exceptionTemporal = New Exceptions.DataAccessException("Invalid user-name/password, The error is generated incorrect password or user, please contact your database administrator", exOracle, command, nameObject, commandKind)
                        'ORA-28001: the password has expired
                Case 28001
                    exceptionTemporal = New Exceptions.DataAccessException("The password has expired, this error is generated by the user password expired, please contact your database administrator", exOracle, command, nameObject, commandKind)
                        'Error con el tns
                Case 12154, 12153, 12152, 12151, 12150
                    exceptionTemporal = New Exceptions.DataAccessException(String.Format("There is an error related to the TNS, the specific error code is {0}", code), exOracle, command, nameObject, commandKind)

                Case 936
                    exceptionTemporal = New Exceptions.DataAccessException(String.Format("Missing expression, the specific error code is {0}", code), exOracle, command, nameObject, commandKind)

                Case 942
                    exceptionTemporal = New Exceptions.DataAccessException(String.Format("The table or view named '{0}' does not exist,  the specific error code is {1}", nameObject, code), exOracle, command, nameObject, commandKind)

                Case 904
                    Dim reg = New Regex(""".*?""")
                    Dim matches = reg.Matches(exOracle.Message)
                    If matches.IsNotEmpty AndAlso matches.Count <> 0 Then
                        Dim item = (From itemMatches In matches Select itemMatches).FirstOrDefault
        ...
        Public Shared Function ProcedureExecute(command As DbCommand, currentConnection As DbConnection) As Integer
            Return CommandExecute(command, currentConnection, command.CommandText, "ProcedureExecute")
        End Function
        ...
        Public Shared Function QueryExecuteScalar(Of T)(command As DbCommand, currentConnection As DbConnection, table As String) As T
            Dim result As T
            Dim watch As Stopwatch
            Dim internalResult As Object = Nothing
                ...
                If ConfigurationManager.AppSettings("DataAccessLayer.Debug").IsNotEmpty AndAlso
                   ConfigurationManager.AppSettings("DataAccessLayer.Debug").Equals("True", StringComparison.CurrentCultureIgnoreCase) Then
                    ...
                    If ConfigurationManager.AppSettings("DataAccessLayer.Debug.DetailsCall").IsNotEmpty AndAlso
                        ...
                        Dim detailsCall As String = AssemblyHandler.GetFrameProcess(4)
                        If detailsCall.IsNotEmpty Then
        ...
        Public Shared Function CommandExecute(command As DbCommand, currentConnection As DbConnection, table As String, commandKind As String) As Integer
            Dim result As Integer = 0
            Dim watch As Stopwatch
            ...
            For attempts As Integer = 1 To 3
                ...
                Try
                    ...
                    If ConfigurationManager.AppSettings("DataAccessLayer.Debug").IsNotEmpty AndAlso
                       ConfigurationManager.AppSettings("DataAccessLayer.Debug").Equals("True", StringComparison.CurrentCultureIgnoreCase) Then
                        ...
                        If ConfigurationManager.AppSettings("DataAccessLayer.Debug.DetailsCall").IsNotEmpty AndAlso
                            ...
                            Dim detailsCall As String = AssemblyHandler.GetFrameProcess(5)
                            If detailsCall.IsNotEmpty Then
                                message &= vbCrLf & String.Format("{0}", detailsCall.ToString.Replace("<<I>>", "              "))
                            End If
                    ...
                    Exit For
                Catch exOracle As OracleException
                    Dim temporalException = ExceptionOracleProcess(exOracle, command, table, "Query")
                    ConnectionClosed(command, currentConnection)
                    Throw temporalException
                Catch ex As Exception
        ...
        Public Shared Function OpenDbConnection(connectionName As String, companyId As Integer) As DbConnection
        ...
        Public Shared Function OpenDbConnectionRaw(connectionStringRaw As String, providerNameRaw As String)
            ...
            If currentProviderFactories.IsNotEmpty Then
                ...
                Catch exOracle As OracleException
                    Throw ExceptionOracleProcess(exOracle, Nothing, "OpenDbConnectionRaw", "Open")
        ...
        Public Shared Function OpenDbConnection(connectionName As String, connectionExtendName As String, companyId As Integer) As DbConnection
            Dim currentProviderFactories As DbProviderFactory = Nothing
            Dim currentConnection As DbConnection = Nothing
            ...
            If currentProviderFactories.IsNotEmpty Then
                ...
                Catch exOracle As OracleException
                    Throw ExceptionOracleProcess(exOracle, Nothing, "OpenDbConnection", "Open")
        ...
        Private Shared Function CreateDateTimeOffsetParameter(parameterInstance As DbParameter) As DbParameter
            ...
            End If
            If fail Then
                Throw New Exceptions.CustomException("It is trying to use a procedure with a xml type parameter, but you can not create xml ttype parameter due to provider, try changing it.")
            End If
...
#Region "Helpers"
                ...
                If command.Parameters.IsNotEmpty Then
                    ...
                    For Each item As DbParameter In command.Parameters
                        ...
                        If IsDBNull(item.Value) Then
                            parameters.Add(item.ParameterName & "." & index, "Null")
                            extra &= vbCrLf
                            ...
                            parameterValue &= "Null,"
                        Else
                            parameters.Add(item.ParameterName & "." & index, String.Format("{0}", item.Value))
                            extra &= vbCrLf
                            If Not addTagInnerException Then
                                extra &= "             "
                            End If
                            extra &= String.Format(" {0}={1}", item.ParameterName, item.Value)
                            If item.DbType = DbType.StringFixedLength Then
                                parameterValue &= String.Format("'{0}',", item.Value)
                            ElseIf item.DbType = DbType.Date Then
                                parameterValue &= DirectCast(item.Value, Date).ToString("yyyy-MM-ddTHH:mm:ss")
                            Else
                                parameterValue &= String.Format("{0},", item.Value)
                            End If
        ...
        Public Shared Function DateValueWithFormat(ByVal connectionName As String, value As Date) As String
            Dim dateFormat As String = ConfigurationManager.AppSettings(String.Format("{0}.DateFormat", connectionName))
...
#Region "CIAMulti"
        ...
        Public Shared Function ConectionStringMultiCompany(stringConection As String, stringConectionName As String, companyId As Integer) As String
            ...
            If Not IsNothing(ConfigurationManager.AppSettings("BackOffice.IsMultiCompany")) AndAlso
               (Boolean.Parse(ConfigurationManager.AppSettings("BackOffice.IsMultiCompany").ToString) = True) Then
                ...
                If Not IsNothing(ConfigurationManager.AppSettings("Core.Mapper")) AndAlso
                                 Not String.IsNullOrEmpty(ConfigurationManager.AppSettings("Core.Mapper").ToString) Then
                    ...
                    If companyId = 0 Then
                        If Not IsNothing(ConfigurationManager.AppSettings("BackOffice.CompanyDefault")) Then
                            companyId = ConfigurationManager.AppSettings("BackOffice.CompanyDefault")
                        End If
                    End If

                    If companyId > 0 Then
                        Dim conectionVecto As String() = ConfigurationManager.AppSettings("Core.Mapper").Split(",")
                        Dim exist As Boolean
                        If conectionVecto.Length = 0 Then
                            exist = String.Equals(ConfigurationManager.AppSettings("Core.Mapper").ToString, stringConectionName)
                        Else
...
#Region "Tools"
        ...
        Public Shared Function OpenLocalDbConnection(connectionString As String, ProviderName As String) As DbConnection
            ...
            If currentProviderFactories.IsNotEmpty Then
                ...
                Catch exOracle As OracleException
                    Throw ExceptionOracleProcess(exOracle, Nothing, "OpenLocalDbConnection", "Open")
        ...
        Public Function ExecuteQuery(ByVal query As String, connectionString As String, providerName As String) As DataTable
            If IsNothing(_dbConnection) Then
                _dbConnection = OpenLocalDbConnection(connectionString, providerName)
            End If
            Return ExecuteQuery(query, String.Empty)
        End Function
        ...
        Public Shared Function RealConnectionStringName(repositoryName As String) As String
            ...
            If IsNothing(ConnectionSetting) Then
                Throw New Exceptions.CustomException("the connection setting for database not found")
            End If
