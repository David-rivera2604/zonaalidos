...
#Region "Connection Methods"
        ...
        Private Function OpenConnection(ByVal connectionStringName As String) As Boolean
            ...
            Dim result As Boolean = OpenConnectionString(ConnectionSetting.ConnectionString, _
                                        ConnectionSetting.ProviderName)

            If result Then
                _owner = ConfigurationManager.AppSettings(String.Format("{0}.Owner", ConnectionSetting.Name))
                DateFormat = ConfigurationManager.AppSettings(String.Format("{0}.DateFormat", ConnectionSetting.Name))
