...
Namespace Helpers
    ...
    Public Class ConnectionStrings
        ...
        Public Shared Function ConnectionStringUserAndPassword(ConectionStringName As String, companyId As Integer) As Services.Contracts.Credential
            ...
            If Not IsNothing(ConfigurationManager.AppSettings("BackOffice.IsMultiCompany")) AndAlso
               (Boolean.Parse(ConfigurationManager.AppSettings("BackOffice.IsMultiCompany").ToString) = True) Then
                ...
                Dim tempConnectionStringName As String = ConfigurationManager.AppSettings(String.Format("{0}.Mapper", ConectionStringName))
                ...
                If String.IsNullOrEmpty(tempConnectionString) Then
        ...
        Public Shared Function ConnectionStringGetAll(CodeValidator As String, companyId As Integer) As List(Of Services.Contracts.ConnectionString)
            ...
            If KeyValidator.KeyValidator(CodeValidator) Then
        ...
        Private Shared Function GetConnectionStrings(connectionStrinName As String, connectionString As String, provider As String, companyId As Integer, filter As Boolean) As Services.Contracts.ConnectionString
            ...
            Else
                ...
                If Not filter Then
                    Dim stringUserAndPasswor As String = String.Format("User ID={0};Password={1}", _User, _Password)
                    result.ConnectionString = String.Format("{0};{1}", connectionString, stringUserAndPasswor)
                Else
                    result.ProviderName = "Oracle.DataAccess.Client"
