...
Namespace Helpers
    ...
    Public Class ExceptionHandlers
        ...
        Public Shared Function Factory(message As String, ex As System.Exception) As Architect.Common.DataType.Result
            Architect.Common.Helpers.LogHandler.ErrorLog(String.Empty, String.Empty, ex)
            Return New Architect.Common.DataType.Result With {.Success = False,
                                                              .Code = 666,
                                                              .Reason = message + ", por favor inténtelo de nuevo o contacte al personal técnico",
                                                              .Detail = ex.Message}
        End Function
