...
Namespace Helpers
    Public NotInheritable Class ByteHandler
        ''' <summary>
        ...
        Public Shared Function FileToBytes(fileName As String) As Byte()
            ...
            If File.Exists(fileName) Then
                ...
                End Using
            Else
                Throw New Exceptions.CustomException(String.Format("The file '{0}' was not found, please check the path", fileName))
            End If
            Return result
        End Function
        ...
        Public Shared Function BytesToFile(FileInBytes As Byte(),
            ...
            If FileInBytes.IsNotEmpty Then
                ...
                Catch ex As Exception
                    Throw New Exceptions.CustomException(String.Format("An error occurred while trying to create the file '{0}', Detail:'{1}'", pathReal, ex.Message))
                End Try

                result = pathReal
            Else
                Throw New Exceptions.CustomException("Byte array can not be empty")
            End If
            Return result
        End Function
        ...
        Public Shared Function BytesToFileHosted(ByVal FileInBytes As System.Byte(),
            ...
            Dim rootPathRelative As String = ConfigurationManager.AppSettings("Url.Files")
            Dim result As String = String.Empty
            If FileInBytes.IsNotEmpty Then
                ...
                Catch ex As Exception
                    Throw New Architect.Common.Exceptions.CustomException(String.Format("An error occurred while trying to create the file '{0}', Detail:'{1}'", rootPhysicalServer, ex.Message))
                End Try

                result = ConfigurationManager.AppSettings("Url.Files") & "/" & NameFile
            Else
                Throw New Architect.Common.Exceptions.CustomException("Byte array can not be empty")
            End If
            Return result
        End Function
