...
Namespace Helpers
    ...
    Public NotInheritable Class Serialize
        ...
        Public Shared Function SerializeJSON(Of T)(current As T) As String
            Return SerializeJSON(Of T)(current, TypeNameHandling.All, PreserveReferencesHandling.Objects)
        End Function

        Public Shared Function SerializeJSON(Of T)(current As T, typeNameHandling As TypeNameHandling, preserveReferencesHandling As PreserveReferencesHandling) As String
            Dim result As String = ""
            Return JsonConvert.SerializeObject(current, Newtonsoft.Json.Formatting.Indented, New JsonSerializerSettings With {
