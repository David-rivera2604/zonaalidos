...
Namespace Helpers
    ...
    Public Class CryptSupportNew
        ...
        Public Shared Function EncryptStringInternal(textPlaint As String) As String
            ...
            Dim key As String = IIf(IsNothing(Configuration.ConfigurationManager.AppSettings("Security.Key")), "FD109115ABDA0FCA1A623D1B016BA909", Configuration.ConfigurationManager.AppSettings("Security.Key"))
            Dim size As Integer = IIf(IsNothing(Configuration.ConfigurationManager.AppSettings("Security.Size")), 128, Configuration.ConfigurationManager.AppSettings("Security.Size"))
