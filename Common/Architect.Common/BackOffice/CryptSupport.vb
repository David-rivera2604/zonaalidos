...
Namespace BackOffice
    ...
    Public NotInheritable Class CryptSupport

        Public Shared Function EncryptString(ByVal sText As String) As String
            EncryptString = HexEncryptString(sText)
        End Function

        Public Shared Function DecryptString(ByVal sText As String) As String
        ...
        Public Shared Function HexEncryptString(ByRef Text As String) As String
            Dim strBuffer As String = ASCIIEncryptString(Text)
            Dim strOutput As String
            Dim intIndex As Short
            Dim intCount As Short = Len(strBuffer)

            strOutput = String.Empty
            For intIndex = 1 To intCount
                strOutput &= Right("00" & Hex(Asc(Mid(strBuffer, intIndex, 1))), 2)
            Next
        ...
        Public Shared Function HexDecryptString(ByRef Text As String) As String
            ...
            For intIndex = 1 To intCount Step 2
                strOutput &= Chr(CInt(Hex2Int(Mid(Text, intIndex, 2))))
            Next
