...
#Region "Long"
        ...
        ''' <returns>Either the Integer or the default value.</returns>
        <Extension()>
        Public Function IfEmpty(ByVal value As Long, defaultValue As Long) As Integer
            If value.IsEmpty Then
                Return defaultValue
            Else
                Return value
...
#Region "Double"
        ...
        ''' <param name="value">The Integer value to check.</param>
        <Extension()>
        Public Function IsNotEmpty(ByVal value As Double) As Boolean
            Return Not value.IsEmpty
        End Function
        ...
        ''' <returns>Either the Integer or the default value.</returns>
        <Extension()>
        Public Function IfEmpty(ByVal value As Double, defaultValue As Double) As Double
            If value.IsEmpty Then
                Return defaultValue
            Else
                Return value
