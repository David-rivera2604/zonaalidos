...
Namespace Extensions
    ...
    Public Module DateExtensions
        ...
        <Extension()>
        Public Function Age(ByVal value As Date) As Integer
            Dim ageValue As Integer = 0

            If value.IsNotEmpty Then
                ageValue = Now.Year - value.Year
                If (Now.Month < value.Month OrElse (Now.Month = value.Month AndAlso Now.Day < value.Day)) Then
                    ageValue -= 1
                End If
            End If
