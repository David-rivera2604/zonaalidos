...
namespace Architect.API.Process.WebApi.Controllers
{
    ...
    public class ProcessSpecSLAController : ApiController
    {
        ...
        [Route("")]
        [Authorize]
        public async Task<IHttpActionResult> Post([FromBody] Architect.API.Process.Contracts.General.ProcessSpecSLA item)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Process.Contracts.General.ProcessSpecSLAResult created = Architect.API.Process.Business.General.ProcessSpecSLA.Create(tokenInfo.CompanyId, tokenInfo.UserId, item);
        ...
        public async Task<IHttpActionResult> Get([FromUri] string filter = "", int beginIndex = 1, int endIndex = int.MaxValue)
        {
            ...
            List<Architect.API.Process.Contracts.General.ProcessSpecSLA> result = null;

            await Task.Run(() =>
            {
                result = Architect.API.Process.Business.General.ProcessSpecSLA.Retrieve(tokenInfo.CompanyId, filter, beginIndex, endIndex);
            }).ConfigureAwait(false);
        ...
        public async Task<IHttpActionResult> Count([FromUri] string filter = "")
        {
            ...
            await Task.Run(() =>
            {
                result = Architect.API.Process.Business.General.ProcessSpecSLA.Count(tokenInfo.CompanyId, filter);
            }).ConfigureAwait(false);
            return Ok(result);
        }
        ...
        public async Task<IHttpActionResult> GetById([FromUri] int id)
        {
            ...
            Architect.API.Process.Contracts.General.ProcessSpecSLA data = null;
            ...
            else
            {
                await Task.Run(() =>
                {
                    data = Architect.API.Process.Business.General.ProcessSpecSLA.RetrieveById(tokenInfo.CompanyId, id);
                    if (data.IsEmpty())
                    {
                        result = NotFound();
                    }
        ...
        [Route("{id:int}")]
        [Authorize]
        public async Task<IHttpActionResult> Put([FromUri] int id, [FromBody] Architect.API.Process.Contracts.General.ProcessSpecSLA item)
        {
            ...
            {
                item.Id = id;
                Architect.API.Process.Contracts.General.ProcessSpecSLAResult updated = Architect.API.Process.Business.General.ProcessSpecSLA.Update(tokenInfo.CompanyId, tokenInfo.UserId, id, item);
        ...
        public async Task<IHttpActionResult> Delete([FromUri] int id)
        {
            ...
            await Task.Run(() =>
            {
                Architect.API.Process.Contracts.General.ProcessSpecSLAResult deleted = Architect.API.Process.Business.General.ProcessSpecSLA.Delete(tokenInfo.CompanyId, tokenInfo.UserId, id);
