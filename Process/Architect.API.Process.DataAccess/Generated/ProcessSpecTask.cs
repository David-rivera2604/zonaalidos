...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecTask
    {
        ...
        public static int LastTaskOrderByStepId(int companyId, int stepId, IDbConnection connection = null)
        {

            return (int)Database.Select("SELECT NVL(MAX(TaskOrder),0) " +
                                          "FROM ProcessSpecTask " +
                                         "WHERE StepId=:StepId AND CompanyId=:CompanyId")
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecTask> RetrieveByStepId(int companyId, int stepId, IDbConnection connection = null)
        {
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecTask</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecTask> RetrieveFull(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                        ...
                        .Query(connection, "Research", new Action<System.Data.IDataReader>((reader) =>
                        {
                            result.Add(DataReaderToProcessSpecTask(reader,
                                    new Architect.API.Process.Contracts.General.ProcessSpecTask()
                                    {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecTask RetrieveFull(int id, int companyId, IDbConnection connection = null)
        {
