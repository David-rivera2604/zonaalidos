...
SELECT DISTINCT
 ...
 ORDER BY CASECOUNT ASC, UM.LASTNAME ASC, UM.FIRSTNAME ASC")
        ...
        /// </summary>
        public static List<Architect.API.Process.Contracts.General.ProcessInstance> RetrieveOverDueSteps(DateTime dueDate, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessInstance> result = new List<Contracts.General.ProcessInstance>();
            Database.Select("SELECT ActivityId, ProcessInstance.InstanceId, CaseId, ProcessInstance.CompanyId, EntityType, EntityId, ProcessInstance.FlowId, StepId, TaskId, Created, StartDate, EarlyDueDate, DueDate, FinishDate, PreviousActivityId, ProcessInstance.UserId, Comments, pc.SLA, ProcessInstance.UpdateUserCode, ProcessInstance.UpdateDate, LastOverDueNotify " +
                        ...
                        {
                            result.Add(new Architect.API.Process.Contracts.General.ProcessInstance()
                            {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessInstance> RetrieveByEntity(int entityType, long entityId, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessInstance> RetrieveByInstanceId(int instanceId, int companyId, IDbConnection connection = null)
        {
