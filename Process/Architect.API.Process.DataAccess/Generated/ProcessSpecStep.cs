...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecStep
    {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStep> RetrieveByFlowId(int companyId, int flowId, IDbConnection connection = null)
        {
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecStep</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStep> RetrieveFull(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT * FROM (" +
                            "SELECT ProcessSpecStep.Id, FlowId, ProcessSpecStep.CompanyId, ProcessSpecStep.Name, ProcessSpecStep.Description, StepOrder, ProcessStatus, ProcessLabel, EnableComment, ProgressMode, ProcessSpecStep.SLA, ProcessSpecStep.SLODuration, ProcessSpecStep.MailServer, MailToContact, MailToContactCustom, MailToContactTmpl, MailToStepResponsible, MailToStepResponsibleCustom, MailToStepResponsibleTmpl, PreScript, PostScript, References, ProcessSpecStep.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecStep.UpdateDate " +
                        ...
                        .Query(connection, "Research", new Action<System.Data.IDataReader>((reader) =>
                        {
                            result.Add(DataReaderToProcessSpecStep(reader,
                                    new Architect.API.Process.Contracts.General.ProcessSpecStep()
                                    {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecStep RetrieveFull(int id, int companyId, IDbConnection connection = null)
        {
