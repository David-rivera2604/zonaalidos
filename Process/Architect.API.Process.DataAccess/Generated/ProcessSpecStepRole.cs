...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecStepRole
    {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> RetrieveByStepId(int stepId, IDbConnection connection = null)
        {
            ...
            Database.Select("SELECT Id, ProcessSpecStepRole.RoleId, rm.RoleName, ProcessSpecStepRole.CompanyId, ProcessSpecStepRole.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecStepRole.UpdateDate " +
                        ...
                        {
                            result.Add(new Architect.API.Process.Contracts.General.ProcessSpecStepRole()
                            {
