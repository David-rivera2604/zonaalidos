...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecSLALevel
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecSLALevel processspecslalevelItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> processspecslalevelItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecSLALevel item in processspecslalevelItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecSLALevel Retrieve(int id, int companyId, IDbConnection connection = null)
        {
            Architect.API.Process.Contracts.General.ProcessSpecSLALevel result = null;
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> result = new List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel>();
            Database.Select("SELECT Id, SLAId, ProcessSpecSLALevel.CompanyId, SLATimeOut, SLATimeMode, MailForSLAExpiration, MailForSLAExpirationCustom, MailForSLAExpirationTmpl, ProcessSpecSLALevel.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecSLALevel.UpdateDate " +
                              "FROM ProcessSpecSLALevel LEFT JOIN UserMember um ON um.UserId = ProcessSpecSLALevel.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecSLALevel</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> result = new List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecSLALevel processspecslalevelItem, IDbConnection connection = null)
        {
            if (processspecslalevelItem.UpdateDate.IsEmpty())
            {
                processspecslalevelItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecSLALevel> processspecslalevelItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecSLALevel DataReaderToProcessSpecSLALevel(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecSLALevel item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecSLALevel();
            }
