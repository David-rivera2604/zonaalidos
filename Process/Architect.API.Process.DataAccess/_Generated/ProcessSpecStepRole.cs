...
{
    /// <summary>
    /// Roles de usuario asociados a un paso o estado de un proceso.
    /// </summary>
    public sealed partial class ProcessSpecStepRole
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecStepRole processspecsteproleItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> processspecsteproleItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecStepRole item in processspecsteproleItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecStepRole Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> result = new List<Architect.API.Process.Contracts.General.ProcessSpecStepRole>();
            Database.Select("SELECT Id, RoleId, ProcessSpecStepRole.CompanyId, ProcessSpecStepRole.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecStepRole.UpdateDate " +
                              "FROM ProcessSpecStepRole LEFT JOIN UserMember um ON um.UserId = ProcessSpecStepRole.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecStepRole</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> result = new List<Architect.API.Process.Contracts.General.ProcessSpecStepRole>();
            if (beginIndex == 0)
            {
        ...
        /// <summary>
        /// Último valor asignado a clave única de la tabla ProcessSpecStepRole.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecStepRole processspecsteproleItem, IDbConnection connection = null)
        {
            if (processspecsteproleItem.UpdateDate.IsEmpty())
            {
                processspecsteproleItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecStepRole> processspecsteproleItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecStepRole DataReaderToProcessSpecStepRole(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecStepRole item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecStepRole();
            }
