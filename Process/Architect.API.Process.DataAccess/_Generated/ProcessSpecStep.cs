...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecStep
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecStep processspecstepItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecStep> processspecstepItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecStep item in processspecstepItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecStep Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStep> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecStep> result = new List<Architect.API.Process.Contracts.General.ProcessSpecStep>();
            Database.Select("SELECT Id, FlowId, ProcessSpecStep.CompanyId, Name, Description, StepOrder, ProcessStatus, ProcessLabel, EnableComment, ProgressMode, SLA, SLODuration, MailServer, MailToContact, MailToContactCustom, MailToContactTmpl, MailToStepResponsible, MailToStepResponsibleCustom, MailToStepResponsibleTmpl, PreScript, PostScript, References, ProcessSpecStep.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecStep.UpdateDate " +
                              "FROM ProcessSpecStep LEFT JOIN UserMember um ON um.UserId = ProcessSpecStep.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecStep</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecStep> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecStep> result = new List<Architect.API.Process.Contracts.General.ProcessSpecStep>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecStep processspecstepItem, IDbConnection connection = null)
        {
            if (processspecstepItem.UpdateDate.IsEmpty())
            {
                processspecstepItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecStep> processspecstepItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecStep DataReaderToProcessSpecStep(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecStep item = null, bool queryExt = false)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecStep();
            }
