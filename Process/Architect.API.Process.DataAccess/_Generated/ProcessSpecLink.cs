...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecLink
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecLink processspeclinkItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecLink> processspeclinkItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecLink item in processspeclinkItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecLink Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecLink> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecLink> result = new List<Architect.API.Process.Contracts.General.ProcessSpecLink>();
            Database.Select("SELECT Id, FlowId, ProcessSpecLink.CompanyId, Name, Description, Icon, Type, LinkOrder, URL, ProcessSpecLink.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecLink.UpdateDate " +
                              "FROM ProcessSpecLink LEFT JOIN UserMember um ON um.UserId = ProcessSpecLink.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecLink</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecLink> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecLink> result = new List<Architect.API.Process.Contracts.General.ProcessSpecLink>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecLink processspeclinkItem, IDbConnection connection = null)
        {
            if (processspeclinkItem.UpdateDate.IsEmpty())
            {
                processspeclinkItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecLink> processspeclinkItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecLink DataReaderToProcessSpecLink(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecLink item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecLink();
            }
