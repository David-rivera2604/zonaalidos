...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public partial class ProcessSpecFlowRole
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecFlowRole processspecflowroleItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole> processspecflowroleItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecFlowRole item in processspecflowroleItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecFlowRole Retrieve(int id, int roleid, int companyId, IDbConnection connection = null)
        {
            Architect.API.Process.Contracts.General.ProcessSpecFlowRole result = null;
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecFlowRole</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole> result = new List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecFlowRole processspecflowroleItem, IDbConnection connection = null)
        {
            if (processspecflowroleItem.UpdateDate.IsEmpty())
            {
                processspecflowroleItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecFlowRole> processspecflowroleItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecFlowRole DataReaderToProcessSpecFlowRole(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecFlowRole item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecFlowRole();
            }
