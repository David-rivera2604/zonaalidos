...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessInstance
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessInstance processinstanceItem, IDbConnection connection = null)
        {
            if (processinstanceItem.UpdateDate.IsEmpty())
            {
                processinstanceItem.UpdateDate = DateTime.Now;
            }
            return Database.Insert("INSERT INTO ProcessInstance (ActivityId, InstanceId, CompanyId, EntityType, EntityId, CaseId, FlowId, StepId, TaskId, Created, StartDate, EarlyDueDate, DueDate, FinishDate, PreviousActivityId, UserId, Comments, LastOverDueNotify, UserAssigned, UserAssignedDate, UpdateUserCode, UpdateDate) " +
                                                 "VALUES(:ActivityId, :InstanceId, :CompanyId, :EntityType, :EntityId, :CaseId, :FlowId, :StepId, :TaskId, :Created, :StartDate, :EarlyDueDate, :DueDate, :FinishDate, :PreviousActivityId, :UserId, :Comments, :LastOverDueNotify, :UserAssigned, :UserAssignedDate, :UpdateUserCode, :UpdateDate)")
                            ...
                            .AddParameter("LastOverDueNotify", DbType.DateTime, 9, processinstanceItem.LastOverDueNotify)
                                                            .AddParameter("UserAssigned", DbType.Decimal, 9, processinstanceItem.UserAssigned)
                                .AddParameter("UserAssignedDate", DbType.DateTime, 0, processinstanceItem.UserAssignedDate)
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessInstance> processinstanceItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessInstance item in processinstanceItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessInstance Retrieve(int activityid, int companyId, IDbConnection connection = null)
        {
            Architect.API.Process.Contracts.General.ProcessInstance result = null;
            Database.Select("SELECT ActivityId, InstanceId, ProcessInstance.CompanyId, EntityType, EntityId, CaseId, FlowId, StepId, TaskId, Created, StartDate, EarlyDueDate, DueDate, FinishDate, PreviousActivityId, ProcessInstance.UserId, Comments, LastOverDueNotify, UserAssigned, UserAssignedDate, ProcessInstance.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessInstance.UpdateDate " +
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessInstance> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessInstance> result = new List<Architect.API.Process.Contracts.General.ProcessInstance>();
            Database.Select("SELECT ActivityId, InstanceId, ProcessInstance.CompanyId, EntityType, EntityId, CaseId, FlowId, StepId, TaskId, Created, StartDate, EarlyDueDate, DueDate, FinishDate, PreviousActivityId, ProcessInstance.UserId, Comments, LastOverDueNotify, UserAssigned, UserAssignedDate, ProcessInstance.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessInstance.UpdateDate " +
                              "FROM ProcessInstance LEFT JOIN UserMember um ON um.UserId = ProcessInstance.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessInstance</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessInstance> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessInstance> result = new List<Architect.API.Process.Contracts.General.ProcessInstance>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessInstance processinstanceItem, IDbConnection connection = null)
        {
            if (processinstanceItem.UpdateDate.IsEmpty())
            {
                processinstanceItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessInstance> processinstanceItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessInstance DataReaderToProcessInstance(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessInstance item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessInstance();
            }
