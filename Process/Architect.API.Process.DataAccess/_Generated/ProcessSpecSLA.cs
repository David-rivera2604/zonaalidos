...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessSpecSLA
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecSLA processspecslaItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecSLA> processspecslaItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecSLA item in processspecslaItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecSLA Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecSLA> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecSLA> result = new List<Architect.API.Process.Contracts.General.ProcessSpecSLA>();
            Database.Select("SELECT Id, ProcessSpecSLA.CompanyId, Name, Description, Status, ProcessSpecSLA.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecSLA.UpdateDate " +
                              "FROM ProcessSpecSLA LEFT JOIN UserMember um ON um.UserId = ProcessSpecSLA.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecSLA</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecSLA> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecSLA> result = new List<Architect.API.Process.Contracts.General.ProcessSpecSLA>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecSLA processspecslaItem, IDbConnection connection = null)
        {
            if (processspecslaItem.UpdateDate.IsEmpty())
            {
                processspecslaItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecSLA> processspecslaItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecSLA DataReaderToProcessSpecSLA(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecSLA item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecSLA();
            }
