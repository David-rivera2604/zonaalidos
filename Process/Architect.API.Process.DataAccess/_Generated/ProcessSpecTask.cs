...
namespace Architect.API.Process.DataAccess.General
{
    ...
    /// </summary>
    public sealed partial class ProcessSpecTask
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessSpecTask processspectaskItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessSpecTask> processspectaskItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessSpecTask item in processspectaskItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecTask Retrieve(int id, int companyId, IDbConnection connection = null)
        {
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessSpecTask> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecTask> result = new List<Architect.API.Process.Contracts.General.ProcessSpecTask>();
            Database.Select("SELECT Id, StepId, ProcessSpecTask.CompanyId, Name, Description, SLATimeOut, IsRequired, IsSelected, TaskOrder, Type, Action, SubStatus, SubLabel, PreScript, PostScript, ProcessSpecTask.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessSpecTask.UpdateDate " +
                              "FROM ProcessSpecTask LEFT JOIN UserMember um ON um.UserId = ProcessSpecTask.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessSpecTask</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessSpecTask> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessSpecTask> result = new List<Architect.API.Process.Contracts.General.ProcessSpecTask>();
            if (beginIndex == 0)
            {
        ...
        public static string FilterBuilder(string filter, bool includeWhere = true)
        {
            ...
            if (filter.IsNotEmpty())
            {
                ...
                {
                    result += Database.FilterFactory(condition, "ProcessSpecTask");
                }				
            }
            return result;
        }
        ...
        /// <summary>
        /// Último valor asignado a clave única de la tabla ProcessSpecTask.
        /// </summary>
        /// <param name="connection">Instancia de una conexión compartida</param>
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessSpecTask processspectaskItem, IDbConnection connection = null)
        {
            if (processspectaskItem.UpdateDate.IsEmpty())
            {
                processspectaskItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessSpecTask> processspectaskItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessSpecTask DataReaderToProcessSpecTask(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessSpecTask item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessSpecTask();
            }
