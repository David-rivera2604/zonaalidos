...
namespace Architect.API.Process.DataAccess.General
{
    ...
    public sealed partial class ProcessCaseComplement
    {
        ...
        public static int Create(Architect.API.Process.Contracts.General.ProcessCaseComplement processcasecomplementItem, IDbConnection connection = null)
        {
        ...
        public static List<int> Create(List<Architect.API.Process.Contracts.General.ProcessCaseComplement> processcasecomplementItems, IDbConnection connection = null)
        {
            ...
            foreach (Architect.API.Process.Contracts.General.ProcessCaseComplement item in processcasecomplementItems)
            {
        ...
        public static Architect.API.Process.Contracts.General.ProcessCaseComplement Retrieve(int caseid, int companyId, IDbConnection connection = null)
        {
            Architect.API.Process.Contracts.General.ProcessCaseComplement result = null;
        ...
        public static List<Architect.API.Process.Contracts.General.ProcessCaseComplement> RetrieveAll(int companyId, string filter, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessCaseComplement> result = new List<Architect.API.Process.Contracts.General.ProcessCaseComplement>();
            Database.Select("SELECT CaseId, ProcessCaseComplement.CompanyId, Fee, Compensation, Deductible, SpareParts, ManPower, Workshop, ManPowerInvoice, SparePartsInvoice, SettlementDate, AppointmentDate, AppointmentTime, AssignedAdvisor, ReportDate, RepairTotalAmount, RepairManPower, RepairSpareParts, SetSpaFee, SetSpaCompensation, SetSpaDeductible, SetSpaSpareParts, SetSpaManPower, SetSpaManPowerInvoice, SetSpaSparePartsInvoice, SetSpaSettlementDate, ProcessCaseComplement.UpdateUserCode, um.FirstName || ' ' || um.LastName AS UpdateUserName, ProcessCaseComplement.UpdateDate " +
                              "FROM ProcessCaseComplement LEFT JOIN UserMember um ON um.UserId = ProcessCaseComplement.UpdateUserCode " +
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista de instancias de ProcessCaseComplement</returns>
        public static List<Architect.API.Process.Contracts.General.ProcessCaseComplement> RetrieveAll(int companyId, string filter, int beginIndex, int endIndex, List<DataFactory.Contracts.Parameter> parameters = null, IDbConnection connection = null)
        {
            List<Architect.API.Process.Contracts.General.ProcessCaseComplement> result = new List<Architect.API.Process.Contracts.General.ProcessCaseComplement>();
            if (beginIndex == 0)
            {
        ...
        public static int Update(Architect.API.Process.Contracts.General.ProcessCaseComplement processcasecomplementItem, IDbConnection connection = null)
        {
            if (processcasecomplementItem.UpdateDate.IsEmpty())
            {
                processcasecomplementItem.UpdateDate = DateTime.Now;
        ...
        /// <param name="connection">Instancia de una conexión compartida</param>
        /// <returns>Lista con el resultado de la creación de cada instancia.</returns>
        public static List<int> Update(List<Architect.API.Process.Contracts.General.ProcessCaseComplement> processcasecomplementItems, IDbConnection connection = null)
        {
            List<int> result = new List<int>();
            bool local = false;
        ...
        public static Architect.API.Process.Contracts.General.ProcessCaseComplement DataReaderToProcessCaseComplement(System.Data.IDataReader reader, Architect.API.Process.Contracts.General.ProcessCaseComplement item = null)
        {
            if (item == null)
            {
                item = new Architect.API.Process.Contracts.General.ProcessCaseComplement();
            }
